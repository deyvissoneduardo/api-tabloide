# US-213 — Receber avisos de vencimento da assinatura
...
**Como** usuário DONO  
**Quero** receber avisos de vencimento da assinatura  
...
Esta história pertence a **Supermercado**, domínio **Planos e assinaturas**, seção “Assinaturas”. O requisito de origem é DEC-RF-006. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar receber avisos de vencimento da assinatura no escopo autorizado.
...
2. O sistema aplica a qualidade “O DONO deve receber avisos de vencimento da assinatura” antes de devolver o resultado.
...
- **RF-001:** O sistema deve receber avisos de vencimento da assinatura.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "receber avisos de vencimento da assinatura"
...
A tela deve apresentar receber avisos de vencimento da assinatura com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `receber_avisos_vencimento_assinatura_iniciado`: início intencional do fluxo.
- `receber_avisos_vencimento_assinatura_concluido`: após confirmação do resultado.
- `receber_avisos_vencimento_assinatura_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-006 — O DONO deve receber avisos de vencimento da assinatura.`
