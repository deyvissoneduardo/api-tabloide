# US-207 — Os principais fluxos devem considerar acessibilidade digital
...
**Quero** os principais fluxos devem considerar acessibilidade digital  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-035. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar os principais fluxos devem considerar acessibilidade digital no escopo autorizado.
...
2. O sistema aplica a qualidade “Os principais fluxos devem considerar acessibilidade digital” antes de devolver o resultado.
...
- **RF-001:** O sistema deve os principais fluxos devem considerar acessibilidade digital.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "os principais fluxos devem considerar acessibilidade digital"
...
A tela deve apresentar os principais fluxos devem considerar acessibilidade digital com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `principais_fluxos_devem_considerar_acessibilidade_digital_iniciado`: início intencional do fluxo.
- `principais_fluxos_devem_considerar_acessibilidade_digital_concluido`: após confirmação do resultado.
- `principais_fluxos_devem_considerar_acessibilidade_digital_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-035 — Os principais fluxos devem considerar acessibilidade digital.`
