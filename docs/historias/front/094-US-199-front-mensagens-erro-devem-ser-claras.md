# US-199 — Mensagens de erro devem ser claras
...
**Quero** mensagens de erro devem ser claras  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-010. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar mensagens de erro devem ser claras no escopo autorizado.
...
2. O sistema aplica a qualidade “Mensagens de erro devem ser claras” antes de devolver o resultado.
...
- **RF-001:** O sistema deve mensagens de erro devem ser claras.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "mensagens de erro devem ser claras"
...
A tela deve apresentar mensagens de erro devem ser claras com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `mensagens_erro_devem_ser_claras_iniciado`: início intencional do fluxo.
- `mensagens_erro_devem_ser_claras_concluido`: após confirmação do resultado.
- `mensagens_erro_devem_ser_claras_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-010 — Mensagens de erro devem ser claras.`
