# US-200 — A página de ofertas deve aparecer rapidamente após a leitura do QR Code
...
**Quero** a página de ofertas deve aparecer rapidamente após a leitura do qr code  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-011. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a página de ofertas deve aparecer rapidamente após a leitura do qr code no escopo autorizado.
...
2. O sistema aplica a qualidade “A página de ofertas deve aparecer rapidamente após a leitura do QR Code” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a página de ofertas deve aparecer rapidamente após a leitura do qr code.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a página de ofertas deve aparecer rapidamente após a leitura do qr code"
...
A tela deve apresentar a página de ofertas deve aparecer rapidamente após a leitura do qr code com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `pagina_ofertas_deve_aparecer_rapidamente_apos_leitura_qr_code_iniciado`: início intencional do fluxo.
- `pagina_ofertas_deve_aparecer_rapidamente_apos_leitura_qr_code_concluido`: após confirmação do resultado.
- `pagina_ofertas_deve_aparecer_rapidamente_apos_leitura_qr_code_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-011 — A página de ofertas deve aparecer rapidamente após a leitura do QR Code.`
