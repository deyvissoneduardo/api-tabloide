# US-157 — Apresentar categorias mais visualizadas
...
**Quero** apresentar categorias mais visualizadas  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B12. Dashboard”. O requisito de origem é SUP-RF-121. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar categorias mais visualizadas no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar categorias mais visualizadas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar categorias mais visualizadas.
...
- **RF-001:** O sistema deve apresentar categorias mais visualizadas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar categorias mais visualizadas"
...
A tela deve apresentar apresentar categorias mais visualizadas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `apresentar_categorias_mais_visualizadas_iniciado`: início intencional do fluxo.
- `apresentar_categorias_mais_visualizadas_concluido`: após confirmação do resultado.
- `apresentar_categorias_mais_visualizadas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-121 — O painel deve apresentar categorias mais visualizadas.`
