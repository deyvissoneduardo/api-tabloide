# US-118 — Acessar sua área administrativa
...
**Quero** acessar sua área administrativa  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-001. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar acessar sua área administrativa no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita acessar sua área administrativa.

---

## 8. Fluxo principal

1. O ator acessa a consulta de acessar sua área administrativa.
...
- **RF-001:** O sistema deve acessar sua área administrativa.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "acessar sua área administrativa"
...
A tela deve apresentar acessar sua área administrativa com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `acessar_area_administrativa_iniciado`: início intencional do fluxo.
- `acessar_area_administrativa_concluido`: após confirmação do resultado.
- `acessar_area_administrativa_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-001 — O supermercado deve poder acessar sua área administrativa.`
