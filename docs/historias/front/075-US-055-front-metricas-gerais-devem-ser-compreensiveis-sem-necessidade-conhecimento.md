# US-055 — As métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico
...
- **Dependências:** Back/US-001, Back/US-106
- **Bloqueia:** Nenhuma
- **Risco:** Médio
...
A capacidade deve implementar as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico usando as regras aprovadas de analytics, dashboard e relatórios. O problema resolvido é permitir um comportamento consistente, autorizado, testável e rastreável para Super Admin do SGTM. O resultado esperado é a conclusão observável da capacidade sem depender do documento de origem.
...
**Quero** as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico  
...
Esta história pertence a **Administração da plataforma**, domínio **Analytics, dashboard e relatórios**. O requisito de origem é ADM-RNF-008. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico no escopo autorizado.
...
2. O sistema aplica a qualidade “As métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico” antes de devolver o resultado.
...
- **RF-001:** O sistema deve as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico"
...
A tela deve apresentar as métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `metricas_gerais_devem_ser_compreensiveis_sem_necessidade_conhecimento_iniciado`: início intencional do fluxo.
- `metricas_gerais_devem_ser_compreensiveis_sem_necessidade_conhecimento_concluido`: após confirmação do resultado.
- `metricas_gerais_devem_ser_compreensiveis_sem_necessidade_conhecimento_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-008 — As métricas gerais devem ser compreensíveis sem necessidade de conhecimento técnico.`
- Decisões aplicáveis: seção “Analytics, dashboard e relatórios” de `docs/historias/decisoes-mvp.md`.
- Histórias relacionadas: US-001, US-106.
