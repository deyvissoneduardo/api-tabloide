...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RF-003. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
O gatilho ocorre quando Super Admin do SGTM solicita encerrar sua sessão.
...
- Item de origem: `ADM-RF-003 — O administrador deve poder encerrar sua sessão.`
