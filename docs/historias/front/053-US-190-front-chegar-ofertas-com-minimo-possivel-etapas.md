# US-190 — Chegar às ofertas com o mínimo possível de etapas
...
**Como** consumidor  
**Quero** chegar às ofertas com o mínimo possível de etapas  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-001. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar chegar às ofertas com o mínimo possível de etapas no escopo autorizado.
...
2. O sistema aplica a qualidade “O consumidor deve chegar às ofertas com o mínimo possível de etapas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve chegar às ofertas com o mínimo possível de etapas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "chegar às ofertas com o mínimo possível de etapas"
...
A tela deve apresentar chegar às ofertas com o mínimo possível de etapas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `chegar_ofertas_com_minimo_possivel_etapas_iniciado`: início intencional do fluxo.
- `chegar_ofertas_com_minimo_possivel_etapas_concluido`: após confirmação do resultado.
- `chegar_ofertas_com_minimo_possivel_etapas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-001 — O consumidor deve chegar às ofertas com o mínimo possível de etapas.`
