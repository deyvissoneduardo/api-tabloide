# US-148 — Visualizar métricas por loja
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B11. Analytics”. O requisito de origem é SUP-RF-111. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Item de origem: `SUP-RF-111 — O supermercado deve poder visualizar métricas por loja.`
