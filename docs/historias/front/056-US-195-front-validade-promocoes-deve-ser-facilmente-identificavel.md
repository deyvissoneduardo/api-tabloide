# US-195 — A validade das promoções deve ser facilmente identificável
...
**Quero** a validade das promoções deve ser facilmente identificável  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-006. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a validade das promoções deve ser facilmente identificável no escopo autorizado.
...
2. O sistema aplica a qualidade “A validade das promoções deve ser facilmente identificável” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a validade das promoções deve ser facilmente identificável.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a validade das promoções deve ser facilmente identificável"
...
A tela deve apresentar a validade das promoções deve ser facilmente identificável com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `validade_promocoes_deve_ser_facilmente_identificavel_iniciado`: início intencional do fluxo.
- `validade_promocoes_deve_ser_facilmente_identificavel_concluido`: após confirmação do resultado.
- `validade_promocoes_deve_ser_facilmente_identificavel_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-006 — A validade das promoções deve ser facilmente identificável.`
