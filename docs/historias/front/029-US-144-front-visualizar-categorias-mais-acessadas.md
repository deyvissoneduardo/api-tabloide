# US-144 — Visualizar categorias mais acessadas
...
**Quero** visualizar categorias mais acessadas  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B11. Analytics”. O requisito de origem é SUP-RF-107. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar categorias mais acessadas no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita visualizar categorias mais acessadas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar categorias mais acessadas.
...
- **RF-001:** O sistema deve visualizar categorias mais acessadas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar categorias mais acessadas"
...
A tela deve apresentar visualizar categorias mais acessadas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_categorias_mais_acessadas_iniciado`: início intencional do fluxo.
- `visualizar_categorias_mais_acessadas_concluido`: após confirmação do resultado.
- `visualizar_categorias_mais_acessadas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-107 — O supermercado deve poder visualizar categorias mais acessadas.`
