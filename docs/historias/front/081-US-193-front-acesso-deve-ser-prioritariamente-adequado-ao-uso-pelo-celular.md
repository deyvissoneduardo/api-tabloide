# US-193 — O acesso deve ser prioritariamente adequado ao uso pelo celular
...
**Quero** o acesso deve ser prioritariamente adequado ao uso pelo celular  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-004. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar o acesso deve ser prioritariamente adequado ao uso pelo celular no escopo autorizado.
...
2. O sistema aplica a qualidade “O acesso deve ser prioritariamente adequado ao uso pelo celular” antes de devolver o resultado.
...
- **RF-001:** O sistema deve o acesso deve ser prioritariamente adequado ao uso pelo celular.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "o acesso deve ser prioritariamente adequado ao uso pelo celular"
...
A tela deve apresentar o acesso deve ser prioritariamente adequado ao uso pelo celular com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `acesso_deve_ser_prioritariamente_adequado_ao_uso_pelo_celular_iniciado`: início intencional do fluxo.
- `acesso_deve_ser_prioritariamente_adequado_ao_uso_pelo_celular_concluido`: após confirmação do resultado.
- `acesso_deve_ser_prioritariamente_adequado_ao_uso_pelo_celular_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-004 — O acesso deve ser prioritariamente adequado ao uso pelo celular.`
