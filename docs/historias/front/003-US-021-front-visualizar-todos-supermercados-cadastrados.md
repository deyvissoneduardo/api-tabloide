# US-021 — Visualizar todos os supermercados cadastrados
...
**Quero** visualizar todos os supermercados cadastrados  
...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-005. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar todos os supermercados cadastrados no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita visualizar todos os supermercados cadastrados.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar todos os supermercados cadastrados.
...
- **RF-001:** O sistema deve visualizar todos os supermercados cadastrados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar todos os supermercados cadastrados"
...
A tela deve apresentar visualizar todos os supermercados cadastrados com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_todos_supermercados_cadastrados_iniciado`: início intencional do fluxo.
- `visualizar_todos_supermercados_cadastrados_concluido`: após confirmação do resultado.
- `visualizar_todos_supermercados_cadastrados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-005 — O administrador deve poder visualizar todos os supermercados cadastrados.`
