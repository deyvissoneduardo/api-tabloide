# US-162 — Compartilhar uma campanha
...
**Como** consumidor  
**Quero** compartilhar uma campanha  
...
Esta história pertence a **Supermercado**, domínio **Compartilhamento**, seção “B15. Compartilhamento”. O requisito de origem é SUP-RF-139. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar compartilhar uma campanha no escopo autorizado.
...
2. O sistema aplica a qualidade “O consumidor deve poder compartilhar uma campanha” antes de devolver o resultado.
...
- **RF-001:** O sistema deve compartilhar uma campanha.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "compartilhar uma campanha"
...
A tela deve apresentar compartilhar uma campanha com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `compartilhar_campanha_iniciado`: início intencional do fluxo.
- `compartilhar_campanha_concluido`: após confirmação do resultado.
- `compartilhar_campanha_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-139 — O consumidor deve poder compartilhar uma campanha.`
