# US-054 — Conseguir localizar um supermercado de forma simples
...
**Quero** conseguir localizar um supermercado de forma simples  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RNF-004. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar conseguir localizar um supermercado de forma simples no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita conseguir localizar um supermercado de forma simples.

---

## 8. Fluxo principal

1. O ator acessa a consulta de conseguir localizar um supermercado de forma simples.
...
- **RF-001:** O sistema deve conseguir localizar um supermercado de forma simples.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "conseguir localizar um supermercado de forma simples"
...
A tela deve apresentar conseguir localizar um supermercado de forma simples com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `conseguir_localizar_supermercado_forma_simples_iniciado`: início intencional do fluxo.
- `conseguir_localizar_supermercado_forma_simples_concluido`: após confirmação do resultado.
- `conseguir_localizar_supermercado_forma_simples_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-004 — O administrador deve conseguir localizar um supermercado de forma simples.`
