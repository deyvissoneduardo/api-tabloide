# US-030 — Visualizar a quantidade de supermercados inativos
...
**Quero** visualizar a quantidade de supermercados inativos  
...
Esta história pertence a **Administração da plataforma**, domínio **Analytics, dashboard e relatórios**. O requisito de origem é ADM-RF-022. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar a quantidade de supermercados inativos no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita visualizar a quantidade de supermercados inativos.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar a quantidade de supermercados inativos.
...
- **RF-001:** O sistema deve visualizar a quantidade de supermercados inativos.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar a quantidade de supermercados inativos"
...
A tela deve apresentar visualizar a quantidade de supermercados inativos com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_quantidade_supermercados_inativos_iniciado`: início intencional do fluxo.
- `visualizar_quantidade_supermercados_inativos_concluido`: após confirmação do resultado.
- `visualizar_quantidade_supermercados_inativos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-022 — O administrador deve poder visualizar a quantidade de supermercados inativos.`
