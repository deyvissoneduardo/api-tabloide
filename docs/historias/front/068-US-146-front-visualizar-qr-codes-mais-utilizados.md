# US-146 — Visualizar QR Codes mais utilizados
...
**Quero** visualizar qr codes mais utilizados  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B11. Analytics”. O requisito de origem é SUP-RF-109. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar qr codes mais utilizados no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita visualizar qr codes mais utilizados.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar qr codes mais utilizados.
...
- **RF-001:** O sistema deve visualizar qr codes mais utilizados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar qr codes mais utilizados"
...
A tela deve apresentar visualizar qr codes mais utilizados com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_qr_codes_mais_utilizados_iniciado`: início intencional do fluxo.
- `visualizar_qr_codes_mais_utilizados_concluido`: após confirmação do resultado.
- `visualizar_qr_codes_mais_utilizados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-109 — O supermercado deve poder visualizar QR Codes mais utilizados.`
