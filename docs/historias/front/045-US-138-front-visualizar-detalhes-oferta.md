# US-138 — Visualizar detalhes da oferta
...
**Como** consumidor  
**Quero** visualizar detalhes da oferta  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-086. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar detalhes da oferta no escopo autorizado.
...
O gatilho ocorre quando consumidor solicita visualizar detalhes da oferta.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar detalhes da oferta.
...
- **RF-001:** O sistema deve visualizar detalhes da oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar detalhes da oferta"
...
A tela deve apresentar visualizar detalhes da oferta com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_detalhes_oferta_iniciado`: início intencional do fluxo.
- `visualizar_detalhes_oferta_concluido`: após confirmação do resultado.
- `visualizar_detalhes_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-086 — O consumidor deve poder visualizar detalhes da oferta.`
