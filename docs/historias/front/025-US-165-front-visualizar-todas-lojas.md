# US-165 — Visualizar todas as lojas
...
**Quero** visualizar todas as lojas  
...
Esta história pertence a **Supermercado**, domínio **Multi-loja**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RF-171. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar todas as lojas no escopo autorizado.
...
O gatilho ocorre quando usuário DONO de uma rede solicita visualizar todas as lojas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar todas as lojas.
...
- **RF-001:** O sistema deve visualizar todas as lojas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar todas as lojas"
...
A tela deve apresentar visualizar todas as lojas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_todas_lojas_iniciado`: início intencional do fluxo.
- `visualizar_todas_lojas_concluido`: após confirmação do resultado.
- `visualizar_todas_lojas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-171 — A rede deve poder visualizar todas as lojas.`
