# US-197 — A administração do supermercado deve utilizar linguagem compreensível para usuários do varejo
...
**Quero** a administração do supermercado deve utilizar linguagem compreensível para usuários do varejo  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-008. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a administração do supermercado deve utilizar linguagem compreensível para usuários do varejo no escopo autorizado.
...
2. O sistema aplica a qualidade “A administração do supermercado deve utilizar linguagem compreensível para usuários do varejo” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a administração do supermercado deve utilizar linguagem compreensível para usuários do varejo.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a administração do supermercado deve utilizar linguagem compreensível para usuários do varejo"
...
A tela deve apresentar a administração do supermercado deve utilizar linguagem compreensível para usuários do varejo com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `administracao_supermercado_deve_utilizar_linguagem_compreensivel_usuar_iniciado`: início intencional do fluxo.
- `administracao_supermercado_deve_utilizar_linguagem_compreensivel_usuar_concluido`: após confirmação do resultado.
- `administracao_supermercado_deve_utilizar_linguagem_compreensivel_usuar_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-008 — A administração do supermercado deve utilizar linguagem compreensível para usuários do varejo.`
