# US-198 — O cadastro de ofertas deve ser simples
...
**Quero** o cadastro de ofertas deve ser simples  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-009. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar o cadastro de ofertas deve ser simples no escopo autorizado.
...
2. O sistema aplica a qualidade “O cadastro de ofertas deve ser simples” antes de devolver o resultado.
...
- **RF-001:** O sistema deve o cadastro de ofertas deve ser simples.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "o cadastro de ofertas deve ser simples"
...
A tela deve apresentar o cadastro de ofertas deve ser simples com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `cadastro_ofertas_deve_ser_simples_iniciado`: início intencional do fluxo.
- `cadastro_ofertas_deve_ser_simples_concluido`: após confirmação do resultado.
- `cadastro_ofertas_deve_ser_simples_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-009 — O cadastro de ofertas deve ser simples.`
