...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-004. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar recuperar seu acesso no escopo autorizado.
...
2. O sistema aplica a qualidade “O usuário deve poder recuperar seu acesso” antes de devolver o resultado.
...
- **RF-001:** O sistema deve recuperar seu acesso.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "recuperar seu acesso"
...
- Item de origem: `SUP-RF-004 — O usuário deve poder recuperar seu acesso.`
