# US-204 — O conteúdo deve possuir contraste adequado
...
**Quero** o conteúdo deve possuir contraste adequado  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-032. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar o conteúdo deve possuir contraste adequado no escopo autorizado.
...
2. O sistema aplica a qualidade “O conteúdo deve possuir contraste adequado” antes de devolver o resultado.
...
- **RF-001:** O sistema deve o conteúdo deve possuir contraste adequado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "o conteúdo deve possuir contraste adequado"
...
A tela deve apresentar o conteúdo deve possuir contraste adequado com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `conteudo_deve_possuir_contraste_adequado_iniciado`: início intencional do fluxo.
- `conteudo_deve_possuir_contraste_adequado_concluido`: após confirmação do resultado.
- `conteudo_deve_possuir_contraste_adequado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-032 — O conteúdo deve possuir contraste adequado.`
