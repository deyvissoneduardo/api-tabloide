# US-156 — Apresentar ofertas mais visualizadas
...
**Quero** apresentar ofertas mais visualizadas  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B12. Dashboard”. O requisito de origem é SUP-RF-120. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar ofertas mais visualizadas no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar ofertas mais visualizadas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar ofertas mais visualizadas.
...
- **RF-001:** O sistema deve apresentar ofertas mais visualizadas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar ofertas mais visualizadas"
...
A tela deve apresentar apresentar ofertas mais visualizadas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `apresentar_ofertas_mais_visualizadas_iniciado`: início intencional do fluxo.
- `apresentar_ofertas_mais_visualizadas_concluido`: após confirmação do resultado.
- `apresentar_ofertas_mais_visualizadas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-120 — O painel deve apresentar ofertas mais visualizadas.`
