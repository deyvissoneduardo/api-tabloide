# US-126 — Apresentar o percentual de desconto quando aplicável
...
**Quero** apresentar o percentual de desconto quando aplicável  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-049. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar o percentual de desconto quando aplicável no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar o percentual de desconto quando aplicável.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar o percentual de desconto quando aplicável.
...
- **RF-001:** O sistema deve apresentar o percentual de desconto quando aplicável.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar o percentual de desconto quando aplicável"
...
A tela deve apresentar apresentar o percentual de desconto quando aplicável com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
A interface consome a API `/api/ofertas` usando o método correspondente à ação. Deve tratar 200/201, 400/422, 401, 403, 404, 409 e 500 quando aplicáveis, sem inferir sucesso antes da resposta.
...
- `apresentar_percentual_desconto_quando_aplicavel_iniciado`: início intencional do fluxo.
- `apresentar_percentual_desconto_quando_aplicavel_concluido`: após confirmação do resultado.
- `apresentar_percentual_desconto_quando_aplicavel_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-049 — O sistema deve apresentar o percentual de desconto quando aplicável.`
