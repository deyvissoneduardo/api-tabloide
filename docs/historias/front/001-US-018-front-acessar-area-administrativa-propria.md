# US-018 — Acessar uma área administrativa própria
...
**Quero** acessar uma área administrativa própria  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RF-001. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar acessar uma área administrativa própria no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita acessar uma área administrativa própria.

---

## 8. Fluxo principal

1. O ator acessa a consulta de acessar uma área administrativa própria.
...
- **RF-001:** O sistema deve acessar uma área administrativa própria.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "acessar uma área administrativa própria"
...
A tela deve apresentar acessar uma área administrativa própria com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `acessar_area_administrativa_propria_iniciado`: início intencional do fluxo.
- `acessar_area_administrativa_propria_concluido`: após confirmação do resultado.
- `acessar_area_administrativa_propria_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-001 — O administrador da plataforma deve poder acessar uma área administrativa própria.`
