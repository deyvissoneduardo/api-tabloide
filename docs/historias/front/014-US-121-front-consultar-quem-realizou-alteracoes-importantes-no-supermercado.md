# US-121 — Consultar quem realizou alterações importantes no seu supermercado
...
**Quero** consultar quem realizou alterações importantes no seu supermercado  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-010. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar consultar quem realizou alterações importantes no seu supermercado no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita consultar quem realizou alterações importantes no seu supermercado.

---

## 8. Fluxo principal

1. O ator acessa a consulta de consultar quem realizou alterações importantes no seu supermercado.
...
- **RF-001:** O sistema deve consultar quem realizou alterações importantes no seu supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "consultar quem realizou alterações importantes no seu supermercado"
...
A tela deve apresentar consultar quem realizou alterações importantes no seu supermercado com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
A interface consome a API `/api/sessoes` usando o método correspondente à ação. Deve tratar 200/201, 400/422, 401, 403, 404, 409 e 500 quando aplicáveis, sem inferir sucesso antes da resposta.
...
- `consultar_quem_realizou_alteracoes_importantes_no_supermercado_iniciado`: início intencional do fluxo.
- `consultar_quem_realizou_alteracoes_importantes_no_supermercado_concluido`: após confirmação do resultado.
- `consultar_quem_realizou_alteracoes_importantes_no_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-010 — O supermercado deve poder consultar quem realizou alterações importantes no seu supermercado.`
