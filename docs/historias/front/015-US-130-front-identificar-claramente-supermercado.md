# US-130 — Identificar claramente o supermercado
...
**Quero** identificar claramente o supermercado  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-076. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar identificar claramente o supermercado no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita identificar claramente o supermercado.

---

## 8. Fluxo principal

1. O ator acessa a consulta de identificar claramente o supermercado.
...
- **RF-001:** O sistema deve identificar claramente o supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "identificar claramente o supermercado"
...
A tela deve apresentar identificar claramente o supermercado com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `identificar_claramente_supermercado_iniciado`: início intencional do fluxo.
- `identificar_claramente_supermercado_concluido`: após confirmação do resultado.
- `identificar_claramente_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-076 — A página deve identificar claramente o supermercado.`
