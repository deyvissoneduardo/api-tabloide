# US-194 — Os preços promocionais devem possuir destaque visual
...
**Quero** os preços promocionais devem possuir destaque visual  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-005. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar os preços promocionais devem possuir destaque visual no escopo autorizado.
...
2. O sistema aplica a qualidade “Os preços promocionais devem possuir destaque visual” antes de devolver o resultado.
...
- **RF-001:** O sistema deve os preços promocionais devem possuir destaque visual.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "os preços promocionais devem possuir destaque visual"
...
A tela deve apresentar os preços promocionais devem possuir destaque visual com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `precos_promocionais_devem_possuir_destaque_visual_iniciado`: início intencional do fluxo.
- `precos_promocionais_devem_possuir_destaque_visual_concluido`: após confirmação do resultado.
- `precos_promocionais_devem_possuir_destaque_visual_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-005 — Os preços promocionais devem possuir destaque visual.`
