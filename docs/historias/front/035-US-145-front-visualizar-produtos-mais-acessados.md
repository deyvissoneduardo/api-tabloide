# US-145 — Visualizar produtos mais acessados
...
**Quero** visualizar produtos mais acessados  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B11. Analytics”. O requisito de origem é SUP-RF-108. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar produtos mais acessados no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita visualizar produtos mais acessados.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar produtos mais acessados.
...
- **RF-001:** O sistema deve visualizar produtos mais acessados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar produtos mais acessados"
...
A tela deve apresentar visualizar produtos mais acessados com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_produtos_mais_acessados_iniciado`: início intencional do fluxo.
- `visualizar_produtos_mais_acessados_concluido`: após confirmação do resultado.
- `visualizar_produtos_mais_acessados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-108 — O supermercado deve poder visualizar produtos mais acessados.`
