# US-143 — Visualizar acessos por data e horário
...
**Quero** visualizar acessos por data e horário  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B11. Analytics”. O requisito de origem é SUP-RF-105. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar acessos por data e horário no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita visualizar acessos por data e horário.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar acessos por data e horário.
...
- **RF-001:** O sistema deve visualizar acessos por data e horário.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar acessos por data e horário"
...
A tela deve apresentar visualizar acessos por data e horário com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_acessos_data_horario_iniciado`: início intencional do fluxo.
- `visualizar_acessos_data_horario_concluido`: após confirmação do resultado.
- `visualizar_acessos_data_horario_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-105 — O supermercado deve poder visualizar acessos por data e horário.`
