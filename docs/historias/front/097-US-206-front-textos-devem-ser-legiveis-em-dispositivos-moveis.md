# US-206 — Textos devem ser legíveis em dispositivos móveis
...
**Quero** textos devem ser legíveis em dispositivos móveis  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-034. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar textos devem ser legíveis em dispositivos móveis no escopo autorizado.
...
2. O sistema aplica a qualidade “Textos devem ser legíveis em dispositivos móveis” antes de devolver o resultado.
...
- **RF-001:** O sistema deve textos devem ser legíveis em dispositivos móveis.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "textos devem ser legíveis em dispositivos móveis"
...
A tela deve apresentar textos devem ser legíveis em dispositivos móveis com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `textos_devem_ser_legiveis_em_dispositivos_moveis_iniciado`: início intencional do fluxo.
- `textos_devem_ser_legiveis_em_dispositivos_moveis_concluido`: após confirmação do resultado.
- `textos_devem_ser_legiveis_em_dispositivos_moveis_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-034 — Textos devem ser legíveis em dispositivos móveis.`
