...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-082. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar preços no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar preços.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar preços.
...
- **RF-001:** O sistema deve apresentar preços.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar preços"
...
A tela deve apresentar apresentar preços com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `apresentar_precos_iniciado`: início intencional do fluxo.
- `apresentar_precos_concluido`: após confirmação do resultado.
- `apresentar_precos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-082 — A página deve apresentar preços.`
