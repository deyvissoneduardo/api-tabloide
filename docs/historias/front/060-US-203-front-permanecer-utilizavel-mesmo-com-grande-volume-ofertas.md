# US-203 — Permanecer utilizável mesmo com grande volume de ofertas
...
**Quero** permanecer utilizável mesmo com grande volume de ofertas  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-014. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar permanecer utilizável mesmo com grande volume de ofertas no escopo autorizado.
...
2. O sistema aplica a qualidade “O painel deve permanecer utilizável mesmo com grande volume de ofertas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve permanecer utilizável mesmo com grande volume de ofertas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "permanecer utilizável mesmo com grande volume de ofertas"
...
A tela deve apresentar permanecer utilizável mesmo com grande volume de ofertas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `permanecer_utilizavel_mesmo_com_grande_volume_ofertas_iniciado`: início intencional do fluxo.
- `permanecer_utilizavel_mesmo_com_grande_volume_ofertas_concluido`: após confirmação do resultado.
- `permanecer_utilizavel_mesmo_com_grande_volume_ofertas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-014 — O painel deve permanecer utilizável mesmo com grande volume de ofertas.`
