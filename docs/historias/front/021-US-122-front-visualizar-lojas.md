...
Esta história pertence a **Supermercado**, domínio **Lojas**, seção “B3. Gestão de lojas”. O requisito de origem é SUP-RF-023. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar visualizar suas lojas no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita visualizar suas lojas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de visualizar suas lojas.
...
- **RF-001:** O sistema deve visualizar suas lojas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "visualizar suas lojas"
...
A tela deve apresentar visualizar suas lojas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `visualizar_lojas_iniciado`: início intencional do fluxo.
- `visualizar_lojas_concluido`: após confirmação do resultado.
- `visualizar_lojas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-023 — O supermercado deve poder visualizar suas lojas.`
