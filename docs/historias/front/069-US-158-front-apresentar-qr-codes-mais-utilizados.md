# US-158 — Apresentar QR Codes mais utilizados
...
**Quero** apresentar qr codes mais utilizados  
...
Esta história pertence a **Supermercado**, domínio **Analytics, dashboard e relatórios**, seção “B12. Dashboard”. O requisito de origem é SUP-RF-122. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar qr codes mais utilizados no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar qr codes mais utilizados.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar qr codes mais utilizados.
...
- **RF-001:** O sistema deve apresentar qr codes mais utilizados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar qr codes mais utilizados"
...
A tela deve apresentar apresentar qr codes mais utilizados com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `apresentar_qr_codes_mais_utilizados_iniciado`: início intencional do fluxo.
- `apresentar_qr_codes_mais_utilizados_concluido`: após confirmação do resultado.
- `apresentar_qr_codes_mais_utilizados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-122 — O painel deve apresentar QR Codes mais utilizados.`
