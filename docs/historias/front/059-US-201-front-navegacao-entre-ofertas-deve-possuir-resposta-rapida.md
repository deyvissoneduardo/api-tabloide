# US-201 — A navegação entre ofertas deve possuir resposta rápida
...
**Quero** a navegação entre ofertas deve possuir resposta rápida  
...
Esta história pertence a **Supermercado**, domínio **Requisitos técnicos e UX recomendados**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-012. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a navegação entre ofertas deve possuir resposta rápida no escopo autorizado.
...
2. O sistema aplica a qualidade “A navegação entre ofertas deve possuir resposta rápida” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a navegação entre ofertas deve possuir resposta rápida.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a navegação entre ofertas deve possuir resposta rápida"
...
A tela deve apresentar a navegação entre ofertas deve possuir resposta rápida com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `navegacao_entre_ofertas_deve_possuir_resposta_rapida_iniciado`: início intencional do fluxo.
- `navegacao_entre_ofertas_deve_possuir_resposta_rapida_concluido`: após confirmação do resultado.
- `navegacao_entre_ofertas_deve_possuir_resposta_rapida_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-012 — A navegação entre ofertas deve possuir resposta rápida.`
