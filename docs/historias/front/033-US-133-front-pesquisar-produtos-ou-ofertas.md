# US-133 — Pesquisar produtos ou ofertas
...
**Como** consumidor  
**Quero** pesquisar produtos ou ofertas  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-080. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar pesquisar produtos ou ofertas no escopo autorizado.
...
O gatilho ocorre quando consumidor solicita pesquisar produtos ou ofertas.

---

## 8. Fluxo principal

1. O ator acessa a consulta de pesquisar produtos ou ofertas.
...
- **RF-001:** O sistema deve pesquisar produtos ou ofertas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "pesquisar produtos ou ofertas"
...
A tela deve apresentar pesquisar produtos ou ofertas com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `pesquisar_produtos_ou_ofertas_iniciado`: início intencional do fluxo.
- `pesquisar_produtos_ou_ofertas_concluido`: após confirmação do resultado.
- `pesquisar_produtos_ou_ofertas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-080 — O consumidor deve poder pesquisar produtos ou ofertas.`
