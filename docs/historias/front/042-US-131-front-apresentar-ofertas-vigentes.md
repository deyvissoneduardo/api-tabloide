# US-131 — Apresentar as ofertas vigentes
...
**Quero** apresentar as ofertas vigentes  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-077. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar apresentar as ofertas vigentes no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita apresentar as ofertas vigentes.

---

## 8. Fluxo principal

1. O ator acessa a consulta de apresentar as ofertas vigentes.
...
- **RF-001:** O sistema deve apresentar as ofertas vigentes.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "apresentar as ofertas vigentes"
...
A tela deve apresentar apresentar as ofertas vigentes com título, contexto atual, controles autorizados e linguagem de varejo. Listas usam pesquisa, filtros e paginação; formulários preservam valores após erro. A ação principal fica desabilitada durante envio.
...
- `apresentar_ofertas_vigentes_iniciado`: início intencional do fluxo.
- `apresentar_ofertas_vigentes_concluido`: após confirmação do resultado.
- `apresentar_ofertas_vigentes_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-077 — A página deve apresentar as ofertas vigentes.`
