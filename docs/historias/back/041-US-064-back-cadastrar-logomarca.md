# US-064 — Cadastrar sua logomarca
...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-013. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar sua logomarca no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar sua logomarca.

---

## 8. Fluxo principal

1. O ator inicia cadastrar sua logomarca.
...
- **RF-001:** O sistema deve cadastrar sua logomarca.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar sua logomarca"
...
- `cadastrar_logomarca_iniciado`: início intencional do fluxo.
- `cadastrar_logomarca_concluido`: após confirmação do resultado.
- `cadastrar_logomarca_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-013 — O supermercado deve poder cadastrar sua logomarca.`
