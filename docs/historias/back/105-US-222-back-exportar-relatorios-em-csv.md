# US-222 — Exportar relatórios em CSV
...
Esta história pertence a **Administração da plataforma**, domínio **Analytics, dashboard e relatórios**, seção “Relatórios”. O requisito de origem é DEC-RF-015. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar exportar relatórios em csv no escopo autorizado.
...
2. O sistema aplica a qualidade “O administrador deve exportar relatórios em CSV” antes de devolver o resultado.
...
- **RF-001:** O sistema deve exportar relatórios em csv.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "exportar relatórios em csv"
...
- `exportar_relatorios_em_csv_iniciado`: início intencional do fluxo.
- `exportar_relatorios_em_csv_concluido`: após confirmação do resultado.
- `exportar_relatorios_em_csv_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-015 — O administrador deve exportar relatórios em CSV.`
