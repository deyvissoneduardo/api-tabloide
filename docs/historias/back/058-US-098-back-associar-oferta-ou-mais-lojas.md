# US-098 — Associar uma oferta a uma ou mais lojas
...
**Quero** associar uma oferta a uma ou mais lojas  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-058. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar associar uma oferta a uma ou mais lojas no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita associar uma oferta a uma ou mais lojas.

---

## 8. Fluxo principal

1. O ator inicia associar uma oferta a uma ou mais lojas.
...
- **RF-001:** O sistema deve associar uma oferta a uma ou mais lojas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "associar uma oferta a uma ou mais lojas"
...
- `associar_oferta_ou_mais_lojas_iniciado`: início intencional do fluxo.
- `associar_oferta_ou_mais_lojas_concluido`: após confirmação do resultado.
- `associar_oferta_ou_mais_lojas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-058 — O supermercado deve poder associar uma oferta a uma ou mais lojas.`
