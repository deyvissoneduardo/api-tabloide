# US-005 — Desativar um supermercado
...
**Quero** desativar um supermercado  
...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-010. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar desativar um supermercado no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita desativar um supermercado.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita desativar um supermercado.
...
- **RF-001:** O sistema deve desativar um supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "desativar um supermercado"
...
- `desativar_supermercado_iniciado`: início intencional do fluxo.
- `desativar_supermercado_concluido`: após confirmação do resultado.
- `desativar_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-010 — O administrador deve poder desativar um supermercado.`
