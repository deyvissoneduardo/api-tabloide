# US-177 — A página pública não deve expor informações administrativas
...
**Quero** a página pública não deve expor informações administrativas  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-024. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a página pública não deve expor informações administrativas no escopo autorizado.
...
2. O sistema aplica a qualidade “A página pública não deve expor informações administrativas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a página pública não deve expor informações administrativas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a página pública não deve expor informações administrativas"
...
- `pagina_publica_nao_deve_expor_informacoes_administrativas_iniciado`: início intencional do fluxo.
- `pagina_publica_nao_deve_expor_informacoes_administrativas_concluido`: após confirmação do resultado.
- `pagina_publica_nao_deve_expor_informacoes_administrativas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-024 — A página pública não deve expor informações administrativas.`
