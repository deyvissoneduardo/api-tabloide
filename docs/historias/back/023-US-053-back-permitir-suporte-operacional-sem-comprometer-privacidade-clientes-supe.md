# US-053 — Permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados
...
**Quero** permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados  
...
Esta história pertence a **Administração da plataforma**, domínio **Suporte e ocorrências**. O requisito de origem é ADM-RNF-015. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados no escopo autorizado.
...
2. O sistema aplica a qualidade “O sistema deve permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados” antes de devolver o resultado.
...
- **RF-001:** O sistema deve permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/ocorrencias`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `permitir_suporte_operacional_sem_comprometer_privacidade_clientes_supe_iniciado`: início intencional do fluxo.
- `permitir_suporte_operacional_sem_comprometer_privacidade_clientes_supe_concluido`: após confirmação do resultado.
- `permitir_suporte_operacional_sem_comprometer_privacidade_clientes_supe_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-015 — O sistema deve permitir suporte operacional sem comprometer a privacidade dos clientes dos supermercados.`
