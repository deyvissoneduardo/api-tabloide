# US-050 — Permitir crescimento do número de supermercados sem alterar o modelo de administração
...
**Quero** permitir crescimento do número de supermercados sem alterar o modelo de administração  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RNF-012. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar permitir crescimento do número de supermercados sem alterar o modelo de administração no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita permitir crescimento do número de supermercados sem alterar o modelo de administração.

---

## 8. Fluxo principal

1. O ator inicia permitir crescimento do número de supermercados sem alterar o modelo de administração.
...
- **RF-001:** O sistema deve permitir crescimento do número de supermercados sem alterar o modelo de administração.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "permitir crescimento do número de supermercados sem alterar o modelo de administração"
...
- `permitir_crescimento_numero_supermercados_sem_alterar_modelo_administr_iniciado`: início intencional do fluxo.
- `permitir_crescimento_numero_supermercados_sem_alterar_modelo_administr_concluido`: após confirmação do resultado.
- `permitir_crescimento_numero_supermercados_sem_alterar_modelo_administr_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-012 — O sistema deve permitir crescimento do número de supermercados sem alterar o modelo de administração.`
