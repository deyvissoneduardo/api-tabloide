# US-208 — Criar planos comerciais
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**, seção “Planos”. O requisito de origem é DEC-RF-001. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar criar planos comerciais no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita criar planos comerciais.

---

## 8. Fluxo principal

1. O ator inicia criar planos comerciais.
...
- **RF-001:** O sistema deve criar planos comerciais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "criar planos comerciais"
...
- `criar_planos_comerciais_iniciado`: início intencional do fluxo.
- `criar_planos_comerciais_concluido`: após confirmação do resultado.
- `criar_planos_comerciais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-001 — O Super Admin deve poder criar planos comerciais.`
