# US-105 — Ativar ou desativar QR Codes
...
**Quero** ativar ou desativar qr codes  
...
Esta história pertence a **Supermercado**, domínio **QR Codes**, seção “B9. QR Code”. O requisito de origem é SUP-RF-094. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ativar ou desativar qr codes no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita ativar ou desativar qr codes.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita ativar ou desativar qr codes.
...
- **RF-001:** O sistema deve ativar ou desativar qr codes.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ativar ou desativar qr codes"
...
Rota: `/api/qrcodes/{id}/acoes/{acao}`
...
- `ativar_ou_desativar_qr_codes_iniciado`: início intencional do fluxo.
- `ativar_ou_desativar_qr_codes_concluido`: após confirmação do resultado.
- `ativar_ou_desativar_qr_codes_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-094 — O supermercado deve poder ativar ou desativar QR Codes.`
