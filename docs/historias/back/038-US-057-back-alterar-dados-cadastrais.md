# US-057 — Alterar seus dados cadastrais
...
**Quero** alterar seus dados cadastrais  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-005. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar alterar seus dados cadastrais no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita alterar seus dados cadastrais.

---

## 8. Fluxo principal

1. O ator inicia alterar seus dados cadastrais.
...
- **RF-001:** O sistema deve alterar seus dados cadastrais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "alterar seus dados cadastrais"
...
- `alterar_dados_cadastrais_iniciado`: início intencional do fluxo.
- `alterar_dados_cadastrais_concluido`: após confirmação do resultado.
- `alterar_dados_cadastrais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-005 — O supermercado deve poder alterar seus dados cadastrais.`
