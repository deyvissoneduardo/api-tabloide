...
**Quero** identificar supermercados com maior utilização da plataforma  
...
Esta história pertence a **Administração da plataforma**, domínio **Analytics, dashboard e relatórios**. O requisito de origem é ADM-RF-030. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar identificar supermercados com maior utilização da plataforma no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita identificar supermercados com maior utilização da plataforma.

---

## 8. Fluxo principal

1. O ator acessa a consulta de identificar supermercados com maior utilização da plataforma.
...
- **RF-001:** O sistema deve identificar supermercados com maior utilização da plataforma.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "identificar supermercados com maior utilização da plataforma"
...
Rota: `/api/metricas` ou `/api/metricas/{id}`, conforme coleção ou detalhe.
...
- `identificar_supermercados_com_maior_utilizacao_plataforma_iniciado`: início intencional do fluxo.
- `identificar_supermercados_com_maior_utilizacao_plataforma_concluido`: após confirmação do resultado.
- `identificar_supermercados_com_maior_utilizacao_plataforma_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-030 — O administrador deve poder identificar supermercados com maior utilização da plataforma.`
