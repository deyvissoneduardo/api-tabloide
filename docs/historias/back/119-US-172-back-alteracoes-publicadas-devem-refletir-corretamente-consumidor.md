# US-172 — Alterações publicadas devem refletir corretamente para o consumidor
...
**Como** consumidor  
**Quero** alterações publicadas devem refletir corretamente para o consumidor  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-019. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar alterações publicadas devem refletir corretamente para o consumidor no escopo autorizado.
...
2. O sistema aplica a qualidade “Alterações publicadas devem refletir corretamente para o consumidor” antes de devolver o resultado.
...
- **RF-001:** O sistema deve alterações publicadas devem refletir corretamente para o consumidor.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "alterações publicadas devem refletir corretamente para o consumidor"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/publico/ofertas`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `alteracoes_publicadas_devem_refletir_corretamente_consumidor_iniciado`: início intencional do fluxo.
- `alteracoes_publicadas_devem_refletir_corretamente_consumidor_concluido`: após confirmação do resultado.
- `alteracoes_publicadas_devem_refletir_corretamente_consumidor_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-019 — Alterações publicadas devem refletir corretamente para o consumidor.`
