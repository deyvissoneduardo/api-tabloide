# US-017 — Administrar conteúdos gerais da plataforma quando necessário
...
**Quero** administrar conteúdos gerais da plataforma quando necessário  
...
Esta história pertence a **Administração da plataforma**, domínio **Conteúdo geral da plataforma**. O requisito de origem é ADM-RF-039. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar administrar conteúdos gerais da plataforma quando necessário no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita administrar conteúdos gerais da plataforma quando necessário.

---

## 8. Fluxo principal

1. O ator inicia administrar conteúdos gerais da plataforma quando necessário.
...
- **RF-001:** O sistema deve administrar conteúdos gerais da plataforma quando necessário.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "administrar conteúdos gerais da plataforma quando necessário"
...
- `administrar_conteudos_gerais_plataforma_quando_necessario_iniciado`: início intencional do fluxo.
- `administrar_conteudos_gerais_plataforma_quando_necessario_concluido`: após confirmação do resultado.
- `administrar_conteudos_gerais_plataforma_quando_necessario_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-039 — O administrador deve poder administrar conteúdos gerais da plataforma quando necessário.`
