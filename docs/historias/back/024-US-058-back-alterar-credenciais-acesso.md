# US-058 — Alterar suas credenciais de acesso
...
**Quero** alterar suas credenciais de acesso  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-006. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar alterar suas credenciais de acesso no escopo autorizado.
...
O gatilho ocorre quando usuário DONO de uma rede solicita alterar suas credenciais de acesso.

---

## 8. Fluxo principal

1. O ator inicia alterar suas credenciais de acesso.
...
- **RF-001:** O sistema deve alterar suas credenciais de acesso.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "alterar suas credenciais de acesso"
...
- `alterar_credenciais_acesso_iniciado`: início intencional do fluxo.
- `alterar_credenciais_acesso_concluido`: após confirmação do resultado.
- `alterar_credenciais_acesso_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-006 — O supermercado deve poder alterar suas credenciais de acesso.`
