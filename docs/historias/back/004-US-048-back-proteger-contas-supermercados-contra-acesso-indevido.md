# US-048 — Proteger contas de supermercados contra acesso indevido
...
**Quero** proteger contas de supermercados contra acesso indevido  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RNF-010. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar proteger contas de supermercados contra acesso indevido no escopo autorizado.
...
2. O sistema aplica a qualidade “O sistema deve proteger contas de supermercados contra acesso indevido” antes de devolver o resultado.
...
- **RF-001:** O sistema deve proteger contas de supermercados contra acesso indevido.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "proteger contas de supermercados contra acesso indevido"
...
- `proteger_contas_supermercados_contra_acesso_indevido_iniciado`: início intencional do fluxo.
- `proteger_contas_supermercados_contra_acesso_indevido_concluido`: após confirmação do resultado.
- `proteger_contas_supermercados_contra_acesso_indevido_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-010 — O sistema deve proteger contas de supermercados contra acesso indevido.`
