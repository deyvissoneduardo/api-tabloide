# US-090 — Informar o preço normal
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-047. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar o preço normal no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar o preço normal.

---

## 8. Fluxo principal

1. O ator inicia informar o preço normal.
...
- **RF-001:** O sistema deve informar o preço normal.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar o preço normal"
...
- `informar_preco_normal_iniciado`: início intencional do fluxo.
- `informar_preco_normal_concluido`: após confirmação do resultado.
- `informar_preco_normal_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-047 — O supermercado deve poder informar o preço normal.`
