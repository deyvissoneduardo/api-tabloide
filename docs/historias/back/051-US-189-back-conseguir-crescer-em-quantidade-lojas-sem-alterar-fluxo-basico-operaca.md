# US-189 — Conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação
...
**Quero** conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação  
...
Esta história pertence a **Supermercado**, domínio **Multi-loja**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-040. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação no escopo autorizado.
...
O gatilho ocorre quando usuário DONO de uma rede solicita conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação.

---

## 8. Fluxo principal

1. O ator inicia conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação.
...
- **RF-001:** O sistema deve conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação"
...
- `conseguir_crescer_em_quantidade_lojas_sem_alterar_fluxo_basico_operaca_iniciado`: início intencional do fluxo.
- `conseguir_crescer_em_quantidade_lojas_sem_alterar_fluxo_basico_operaca_concluido`: após confirmação do resultado.
- `conseguir_crescer_em_quantidade_lojas_sem_alterar_fluxo_basico_operaca_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-040 — Uma rede deve conseguir crescer em quantidade de lojas sem alterar o fluxo básico de operação.`
