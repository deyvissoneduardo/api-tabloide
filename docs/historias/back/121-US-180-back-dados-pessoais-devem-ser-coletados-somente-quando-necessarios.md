# US-180 — Dados pessoais devem ser coletados somente quando necessários
...
**Quero** dados pessoais devem ser coletados somente quando necessários  
...
Esta história pertence a **Supermercado**, domínio **Privacidade e consentimento**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-027. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar dados pessoais devem ser coletados somente quando necessários no escopo autorizado.
...
2. O sistema aplica a qualidade “Dados pessoais devem ser coletados somente quando necessários” antes de devolver o resultado.
...
- **RF-001:** O sistema deve dados pessoais devem ser coletados somente quando necessários.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "dados pessoais devem ser coletados somente quando necessários"
...
- `dados_pessoais_devem_ser_coletados_somente_quando_necessarios_iniciado`: início intencional do fluxo.
- `dados_pessoais_devem_ser_coletados_somente_quando_necessarios_concluido`: após confirmação do resultado.
- `dados_pessoais_devem_ser_coletados_somente_quando_necessarios_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-027 — Dados pessoais devem ser coletados somente quando necessários.`
