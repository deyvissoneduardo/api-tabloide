# US-112 — Cadastrar mensagens promocionais
...
**Quero** cadastrar mensagens promocionais  
...
Esta história pertence a **Supermercado**, domínio **Conteúdos promocionais**, seção “B20. Conteúdos promocionais”. O requisito de origem é SUP-RF-165. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar mensagens promocionais no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar mensagens promocionais.

---

## 8. Fluxo principal

1. O ator inicia cadastrar mensagens promocionais.
...
- **RF-001:** O sistema deve cadastrar mensagens promocionais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar mensagens promocionais"
...
Rota: `/api/conteudos-promocionais`
...
- `cadastrar_mensagens_promocionais_iniciado`: início intencional do fluxo.
- `cadastrar_mensagens_promocionais_concluido`: após confirmação do resultado.
- `cadastrar_mensagens_promocionais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-165 — O supermercado deve poder cadastrar mensagens promocionais.`
