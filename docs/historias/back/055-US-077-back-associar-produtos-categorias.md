# US-077 — Associar produtos a categorias
...
**Quero** associar produtos a categorias  
...
Esta história pertence a **Supermercado**, domínio **Categorias**, seção “B4. Categorias”. O requisito de origem é SUP-RF-031. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar associar produtos a categorias no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita associar produtos a categorias.

---

## 8. Fluxo principal

1. O ator inicia associar produtos a categorias.
...
- **RF-001:** O sistema deve associar produtos a categorias.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "associar produtos a categorias"
...
- `associar_produtos_categorias_iniciado`: início intencional do fluxo.
- `associar_produtos_categorias_concluido`: após confirmação do resultado.
- `associar_produtos_categorias_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-031 — O supermercado deve poder associar produtos a categorias.`
