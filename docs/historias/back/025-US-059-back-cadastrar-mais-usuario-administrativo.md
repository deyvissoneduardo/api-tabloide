# US-059 — Cadastrar mais de um usuário administrativo
...
**Quero** cadastrar mais de um usuário administrativo  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-007. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar mais de um usuário administrativo no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar mais de um usuário administrativo.

---

## 8. Fluxo principal

1. O ator inicia cadastrar mais de um usuário administrativo.
...
- **RF-001:** O sistema deve cadastrar mais de um usuário administrativo.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar mais de um usuário administrativo"
...
- `cadastrar_mais_usuario_administrativo_iniciado`: início intencional do fluxo.
- `cadastrar_mais_usuario_administrativo_concluido`: após confirmação do resultado.
- `cadastrar_mais_usuario_administrativo_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-007 — O supermercado deve poder cadastrar mais de um usuário administrativo.`
