# US-084 — Informar peso, unidade ou volume
...
**Quero** informar peso, unidade ou volume  
...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-039. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar peso, unidade ou volume no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar peso, unidade ou volume.

---

## 8. Fluxo principal

1. O ator inicia informar peso, unidade ou volume.
...
- **RF-001:** O sistema deve informar peso, unidade ou volume.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar peso, unidade ou volume"
...
- `informar_peso_unidade_ou_volume_iniciado`: início intencional do fluxo.
- `informar_peso_unidade_ou_volume_concluido`: após confirmação do resultado.
- `informar_peso_unidade_ou_volume_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-039 — O supermercado deve poder informar peso, unidade ou volume.`
