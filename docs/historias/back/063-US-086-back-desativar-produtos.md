...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-041. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar desativar produtos no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita desativar produtos.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita desativar produtos.
...
- **RF-001:** O sistema deve desativar produtos.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "desativar produtos"
...
Rota: `/api/produtos/{id}/acoes/{acao}`
...
- `desativar_produtos_iniciado`: início intencional do fluxo.
- `desativar_produtos_concluido`: após confirmação do resultado.
- `desativar_produtos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-041 — O supermercado deve poder desativar produtos.`
