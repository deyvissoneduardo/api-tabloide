# US-117 — Administrar várias lojas em uma conta
...
**Quero** administrar várias lojas em uma conta  
...
Esta história pertence a **Supermercado**, domínio **Multi-loja**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RF-170. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar administrar várias lojas em uma conta no escopo autorizado.
...
O gatilho ocorre quando usuário DONO de uma rede solicita administrar várias lojas em uma conta.

---

## 8. Fluxo principal

1. O ator inicia administrar várias lojas em uma conta.
...
- **RF-001:** O sistema deve administrar várias lojas em uma conta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "administrar várias lojas em uma conta"
...
- `administrar_varias_lojas_em_conta_iniciado`: início intencional do fluxo.
- `administrar_varias_lojas_em_conta_concluido`: após confirmação do resultado.
- `administrar_varias_lojas_em_conta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-170 — Uma rede deve poder administrar várias lojas em uma conta.`
