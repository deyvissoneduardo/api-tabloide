...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-053. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cancelar uma oferta no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cancelar uma oferta.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita cancelar uma oferta.
...
- **RF-001:** O sistema deve cancelar uma oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cancelar uma oferta"
...
- `cancelar_oferta_iniciado`: início intencional do fluxo.
- `cancelar_oferta_concluido`: após confirmação do resultado.
- `cancelar_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-053 — O supermercado deve poder cancelar uma oferta.`
