# US-091 — Informar o preço promocional
...
**Quero** informar o preço promocional  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-048. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar o preço promocional no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar o preço promocional.

---

## 8. Fluxo principal

1. O ator inicia informar o preço promocional.
...
- **RF-001:** O sistema deve informar o preço promocional.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar o preço promocional"
...
- `informar_preco_promocional_iniciado`: início intencional do fluxo.
- `informar_preco_promocional_concluido`: após confirmação do resultado.
- `informar_preco_promocional_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-048 — O supermercado deve poder informar o preço promocional.`
