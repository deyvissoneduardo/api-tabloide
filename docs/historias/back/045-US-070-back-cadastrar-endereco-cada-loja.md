# US-070 — Cadastrar o endereço de cada loja
...
**Quero** cadastrar o endereço de cada loja  
...
Esta história pertence a **Supermercado**, domínio **Lojas**, seção “B3. Gestão de lojas”. O requisito de origem é SUP-RF-021. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar o endereço de cada loja no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar o endereço de cada loja.

---

## 8. Fluxo principal

1. O ator inicia cadastrar o endereço de cada loja.
...
- **RF-001:** O sistema deve cadastrar o endereço de cada loja.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar o endereço de cada loja"
...
- `cadastrar_endereco_cada_loja_iniciado`: início intencional do fluxo.
- `cadastrar_endereco_cada_loja_concluido`: após confirmação do resultado.
- `cadastrar_endereco_cada_loja_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-021 — O supermercado deve poder cadastrar o endereço de cada loja.`
