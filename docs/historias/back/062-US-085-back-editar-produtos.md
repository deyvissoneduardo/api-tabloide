...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-040. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar editar produtos no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita editar produtos.

---

## 8. Fluxo principal

1. O ator inicia editar produtos.
...
- **RF-001:** O sistema deve editar produtos.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "editar produtos"
...
- `editar_produtos_iniciado`: início intencional do fluxo.
- `editar_produtos_concluido`: após confirmação do resultado.
- `editar_produtos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-040 — O supermercado deve poder editar produtos.`
