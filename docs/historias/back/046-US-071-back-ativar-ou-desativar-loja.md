# US-071 — Ativar ou desativar uma loja
...
- **Dependências:** Back/US-056, Back/US-068
- **Bloqueia:** Nenhuma
- **Risco:** Baixo
...
Estimativa relativa baseada no escopo descrito, nos cenários de validação e teste, no risco baixo e em 2 dependência(s) identificada(s).
...
**Quero** ativar ou desativar uma loja  
...
Esta história pertence a **Supermercado**, domínio **Lojas**, seção “B3. Gestão de lojas”. O requisito de origem é SUP-RF-022. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ativar ou desativar uma loja no escopo autorizado.
- Aplicar as regras de lojas documentadas nesta história.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita ativar ou desativar uma loja.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita ativar ou desativar uma loja.
...
**Aplicação:**  
Nos fluxos de lojas afetados por esta história.
...
- **RF-001:** O sistema deve ativar ou desativar uma loja.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ativar ou desativar uma loja"
...
ATIVA -> desativação -> DESATIVADA; DESATIVADA -> reativação -> ATIVA.
...
- `ativar_ou_desativar_loja_iniciado`: início intencional do fluxo.
- `ativar_ou_desativar_loja_concluido`: após confirmação do resultado.
- `ativar_ou_desativar_loja_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-022 — O supermercado deve poder ativar ou desativar uma loja.`
- Decisões aplicáveis: seção “Lojas” de `docs/historias/decisoes-mvp.md`.
- Histórias relacionadas: US-056, US-068.
