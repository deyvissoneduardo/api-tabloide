...
- **Bloqueia:** Back/US-075, Back/US-076, Back/US-077, Back/US-078, Back/US-079, Back/US-080, Back/US-081, Back/US-082, Back/US-083, Back/US-084, Back/US-085, Back/US-086, Back/US-087, Front/US-124, Front/US-125, Back/US-186
- **Risco:** Médio
...
Esta história pertence a **Supermercado**, domínio **Categorias**, seção “B4. Categorias”. O requisito de origem é SUP-RF-027. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar categorias no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar categorias.

---

## 8. Fluxo principal

1. O ator inicia cadastrar categorias.
...
- **RF-001:** O sistema deve cadastrar categorias.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar categorias"
...
- `cadastrar_categorias_iniciado`: início intencional do fluxo.
- `cadastrar_categorias_concluido`: após confirmação do resultado.
- `cadastrar_categorias_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-027 — O supermercado deve poder cadastrar categorias.`
