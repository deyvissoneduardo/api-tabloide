# US-218 — Controlar a cota de imagens do supermercado
...
**Quero** controlar a cota de imagens do supermercado  
...
Esta história pertence a **Supermercado**, domínio **Armazenamento e imagens**, seção “Armazenamento”. O requisito de origem é DEC-RF-011. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar controlar a cota de imagens do supermercado no escopo autorizado.
...
2. O sistema aplica a qualidade “O sistema deve controlar a cota de imagens do supermercado” antes de devolver o resultado.
...
- **RF-001:** O sistema deve controlar a cota de imagens do supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "controlar a cota de imagens do supermercado"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/imagens`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `controlar_cota_imagens_supermercado_iniciado`: início intencional do fluxo.
- `controlar_cota_imagens_supermercado_concluido`: após confirmação do resultado.
- `controlar_cota_imagens_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-011 — O sistema deve controlar a cota de imagens do supermercado.`
