# US-072 — Administrar ofertas separadamente por loja
...
**Quero** administrar ofertas separadamente por loja  
...
Esta história pertence a **Supermercado**, domínio **Lojas**, seção “B3. Gestão de lojas”. O requisito de origem é SUP-RF-024. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar administrar ofertas separadamente por loja no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita administrar ofertas separadamente por loja.

---

## 8. Fluxo principal

1. O ator inicia administrar ofertas separadamente por loja.
...
- **RF-001:** O sistema deve administrar ofertas separadamente por loja.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "administrar ofertas separadamente por loja"
...
- `administrar_ofertas_separadamente_loja_iniciado`: início intencional do fluxo.
- `administrar_ofertas_separadamente_loja_concluido`: após confirmação do resultado.
- `administrar_ofertas_separadamente_loja_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-024 — O supermercado deve poder administrar ofertas separadamente por loja.`
