...
Esta história pertence a **Supermercado**, domínio **Conteúdos promocionais**, seção “B20. Conteúdos promocionais”. O requisito de origem é SUP-RF-166. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar publicar avisos no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita publicar avisos.

---

## 8. Fluxo principal

1. O ator inicia publicar avisos.
...
- **RF-001:** O sistema deve publicar avisos.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "publicar avisos"
...
- `publicar_avisos_iniciado`: início intencional do fluxo.
- `publicar_avisos_concluido`: após confirmação do resultado.
- `publicar_avisos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-166 — O supermercado deve poder publicar avisos.`
