# US-002 — Cadastrar um supermercado manualmente
...
**Quero** cadastrar um supermercado manualmente  
...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-007. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar um supermercado manualmente no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita cadastrar um supermercado manualmente.

---

## 8. Fluxo principal

1. O ator inicia cadastrar um supermercado manualmente.
...
- **RF-001:** O sistema deve cadastrar um supermercado manualmente.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar um supermercado manualmente"
...
- `cadastrar_supermercado_manualmente_iniciado`: início intencional do fluxo.
- `cadastrar_supermercado_manualmente_concluido`: após confirmação do resultado.
- `cadastrar_supermercado_manualmente_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-007 — O administrador deve poder cadastrar um supermercado manualmente.`
