# US-079 — Informar o nome do produto
...
**Quero** informar o nome do produto  
...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-034. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar o nome do produto no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar o nome do produto.

---

## 8. Fluxo principal

1. O ator inicia informar o nome do produto.
...
- **RF-001:** O sistema deve informar o nome do produto.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar o nome do produto"
...
- `informar_nome_produto_iniciado`: início intencional do fluxo.
- `informar_nome_produto_concluido`: após confirmação do resultado.
- `informar_nome_produto_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-034 — O supermercado deve poder informar o nome do produto.`
