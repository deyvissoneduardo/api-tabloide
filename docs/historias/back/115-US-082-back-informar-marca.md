...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-037. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar a marca no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar a marca.

---

## 8. Fluxo principal

1. O ator inicia informar a marca.
...
- **RF-001:** O sistema deve informar a marca.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar a marca"
...
- `informar_marca_iniciado`: início intencional do fluxo.
- `informar_marca_concluido`: após confirmação do resultado.
- `informar_marca_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-037 — O supermercado deve poder informar a marca.`
