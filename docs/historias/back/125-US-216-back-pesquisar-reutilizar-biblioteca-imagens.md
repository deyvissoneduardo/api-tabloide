# US-216 — Pesquisar e reutilizar sua biblioteca de imagens
...
**Quero** pesquisar e reutilizar sua biblioteca de imagens  
...
Esta história pertence a **Supermercado**, domínio **Armazenamento e imagens**, seção “Imagens”. O requisito de origem é DEC-RF-009. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar pesquisar e reutilizar sua biblioteca de imagens no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita pesquisar e reutilizar sua biblioteca de imagens.

---

## 8. Fluxo principal

1. O ator acessa a consulta de pesquisar e reutilizar sua biblioteca de imagens.
...
- **RF-001:** O sistema deve pesquisar e reutilizar sua biblioteca de imagens.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "pesquisar e reutilizar sua biblioteca de imagens"
...
Rota: `/api/imagens` ou `/api/imagens/{id}`, conforme coleção ou detalhe.
...
- `pesquisar_reutilizar_biblioteca_imagens_iniciado`: início intencional do fluxo.
- `pesquisar_reutilizar_biblioteca_imagens_concluido`: após confirmação do resultado.
- `pesquisar_reutilizar_biblioteca_imagens_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-009 — O supermercado deve pesquisar e reutilizar sua biblioteca de imagens.`
