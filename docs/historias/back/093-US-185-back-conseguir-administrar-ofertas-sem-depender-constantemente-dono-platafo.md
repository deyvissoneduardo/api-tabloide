# US-185 — Conseguir administrar suas ofertas sem depender constantemente do dono da plataforma
...
A capacidade deve implementar conseguir administrar suas ofertas sem depender constantemente do dono da plataforma usando as regras aprovadas de campanhas. O problema resolvido é permitir um comportamento consistente, autorizado, testável e rastreável para usuário DONO. O resultado esperado é a conclusão observável da capacidade sem depender do documento de origem.
...
**Como** usuário DONO  
**Quero** conseguir administrar suas ofertas sem depender constantemente do dono da plataforma  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-036. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar conseguir administrar suas ofertas sem depender constantemente do dono da plataforma no escopo autorizado.
...
O gatilho ocorre quando usuário DONO solicita conseguir administrar suas ofertas sem depender constantemente do dono da plataforma.

---

## 8. Fluxo principal

1. O ator inicia conseguir administrar suas ofertas sem depender constantemente do dono da plataforma.
...
- **RF-001:** O sistema deve conseguir administrar suas ofertas sem depender constantemente do dono da plataforma.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "conseguir administrar suas ofertas sem depender constantemente do dono da plataforma"
...
- `conseguir_administrar_ofertas_sem_depender_constantemente_dono_platafo_iniciado`: início intencional do fluxo.
- `conseguir_administrar_ofertas_sem_depender_constantemente_dono_platafo_concluido`: após confirmação do resultado.
- `conseguir_administrar_ofertas_sem_depender_constantemente_dono_platafo_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-036 — O supermercado deve conseguir administrar suas ofertas sem depender constantemente do dono da plataforma.`
