# US-110 — Informar a validade do tabloide
...
**Quero** informar a validade do tabloide  
...
Esta história pertence a **Supermercado**, domínio **Tabloide existente**, seção “B19. Tabloide existente”. O requisito de origem é SUP-RF-162. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar a validade do tabloide no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar a validade do tabloide.

---

## 8. Fluxo principal

1. O ator inicia informar a validade do tabloide.
...
- **RF-001:** O sistema deve informar a validade do tabloide.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar a validade do tabloide"
...
- `informar_validade_tabloide_iniciado`: início intencional do fluxo.
- `informar_validade_tabloide_concluido`: após confirmação do resultado.
- `informar_validade_tabloide_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-162 — O supermercado deve poder informar a validade do tabloide.`
