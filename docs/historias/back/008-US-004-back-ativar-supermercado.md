...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-009. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ativar um supermercado no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita ativar um supermercado.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita ativar um supermercado.
...
- **RF-001:** O sistema deve ativar um supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ativar um supermercado"
...
- `ativar_supermercado_iniciado`: início intencional do fluxo.
- `ativar_supermercado_concluido`: após confirmação do resultado.
- `ativar_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-009 — O administrador deve poder ativar um supermercado.`
