# US-212 — Processar o vencimento das assinaturas
...
**Quero** processar o vencimento das assinaturas  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**, seção “Assinaturas”. O requisito de origem é DEC-RF-005. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar processar o vencimento das assinaturas no escopo autorizado.
...
2. O sistema aplica a qualidade “O sistema deve processar o vencimento das assinaturas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve processar o vencimento das assinaturas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "processar o vencimento das assinaturas"
...
- `processar_vencimento_assinaturas_iniciado`: início intencional do fluxo.
- `processar_vencimento_assinaturas_concluido`: após confirmação do resultado.
- `processar_vencimento_assinaturas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-005 — O sistema deve processar o vencimento das assinaturas.`
