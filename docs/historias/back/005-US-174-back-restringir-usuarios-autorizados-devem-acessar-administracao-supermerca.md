# US-174 — Restringir usuários autorizados devem acessar a administração do supermercado
...
**Quero** restringir usuários autorizados devem acessar a administração do supermercado  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-021. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar restringir usuários autorizados devem acessar a administração do supermercado no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita restringir usuários autorizados devem acessar a administração do supermercado.

---

## 8. Fluxo principal

1. O ator acessa a consulta de restringir usuários autorizados devem acessar a administração do supermercado.
...
- **RF-001:** O sistema deve restringir usuários autorizados devem acessar a administração do supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "restringir usuários autorizados devem acessar a administração do supermercado"
...
- `restringir_usuarios_autorizados_devem_acessar_administracao_supermerca_iniciado`: início intencional do fluxo.
- `restringir_usuarios_autorizados_devem_acessar_administracao_supermerca_concluido`: após confirmação do resultado.
- `restringir_usuarios_autorizados_devem_acessar_administracao_supermerca_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-021 — Somente usuários autorizados devem acessar a administração do supermercado.`
