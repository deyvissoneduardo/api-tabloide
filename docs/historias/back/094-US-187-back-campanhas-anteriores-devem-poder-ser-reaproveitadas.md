# US-187 — Campanhas anteriores devem poder ser reaproveitadas
...
**Quero** campanhas anteriores devem poder ser reaproveitadas  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-038. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar campanhas anteriores devem poder ser reaproveitadas no escopo autorizado.
...
2. O sistema aplica a qualidade “Campanhas anteriores devem poder ser reaproveitadas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve campanhas anteriores devem poder ser reaproveitadas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "campanhas anteriores devem poder ser reaproveitadas"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/campanhas`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `campanhas_anteriores_devem_poder_ser_reaproveitadas_iniciado`: início intencional do fluxo.
- `campanhas_anteriores_devem_poder_ser_reaproveitadas_concluido`: após confirmação do resultado.
- `campanhas_anteriores_devem_poder_ser_reaproveitadas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-038 — Campanhas anteriores devem poder ser reaproveitadas.`
