...
**Quero** identificar supermercados inativos ou com baixa utilização  
...
Esta história pertence a **Administração da plataforma**, domínio **Analytics, dashboard e relatórios**. O requisito de origem é ADM-RF-031. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar identificar supermercados inativos ou com baixa utilização no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita identificar supermercados inativos ou com baixa utilização.

---

## 8. Fluxo principal

1. O ator acessa a consulta de identificar supermercados inativos ou com baixa utilização.
...
- **RF-001:** O sistema deve identificar supermercados inativos ou com baixa utilização.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "identificar supermercados inativos ou com baixa utilização"
...
- `identificar_supermercados_inativos_ou_com_baixa_utilizacao_iniciado`: início intencional do fluxo.
- `identificar_supermercados_inativos_ou_com_baixa_utilizacao_concluido`: após confirmação do resultado.
- `identificar_supermercados_inativos_ou_com_baixa_utilizacao_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-031 — O administrador deve poder identificar supermercados inativos ou com baixa utilização.`
