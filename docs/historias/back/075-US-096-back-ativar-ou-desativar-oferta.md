# US-096 — Ativar ou desativar uma oferta
...
**Quero** ativar ou desativar uma oferta  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-054. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ativar ou desativar uma oferta no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita ativar ou desativar uma oferta.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita ativar ou desativar uma oferta.
...
- **RF-001:** O sistema deve ativar ou desativar uma oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ativar ou desativar uma oferta"
...
- `ativar_ou_desativar_oferta_iniciado`: início intencional do fluxo.
- `ativar_ou_desativar_oferta_concluido`: após confirmação do resultado.
- `ativar_ou_desativar_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-054 — O supermercado deve poder ativar ou desativar uma oferta.`
