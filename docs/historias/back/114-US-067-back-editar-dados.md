...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-016. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar editar seus dados no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita editar seus dados.

---

## 8. Fluxo principal

1. O ator inicia editar seus dados.
...
- **RF-001:** O sistema deve editar seus dados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "editar seus dados"
...
- `editar_dados_iniciado`: início intencional do fluxo.
- `editar_dados_concluido`: após confirmação do resultado.
- `editar_dados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-016 — O supermercado deve poder editar seus dados.`
