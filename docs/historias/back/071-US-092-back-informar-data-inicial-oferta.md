# US-092 — Informar a data inicial da oferta
...
**Quero** informar a data inicial da oferta  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-050. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar a data inicial da oferta no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar a data inicial da oferta.

---

## 8. Fluxo principal

1. O ator inicia informar a data inicial da oferta.
...
- **RF-001:** O sistema deve informar a data inicial da oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar a data inicial da oferta"
...
- `informar_data_inicial_oferta_iniciado`: início intencional do fluxo.
- `informar_data_inicial_oferta_concluido`: após confirmação do resultado.
- `informar_data_inicial_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-050 — O supermercado deve poder informar a data inicial da oferta.`
