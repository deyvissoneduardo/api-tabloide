# US-061 — Ativar ou desativar seus usuários
...
**Quero** ativar ou desativar seus usuários  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-009. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ativar ou desativar seus usuários no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita ativar ou desativar seus usuários.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita ativar ou desativar seus usuários.
...
- **RF-001:** O sistema deve ativar ou desativar seus usuários.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ativar ou desativar seus usuários"
...
Rota: `/api/sessoes/{id}/acoes/{acao}`
...
- `ativar_ou_desativar_usuarios_iniciado`: início intencional do fluxo.
- `ativar_ou_desativar_usuarios_concluido`: após confirmação do resultado.
- `ativar_ou_desativar_usuarios_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-009 — O supermercado deve poder ativar ou desativar seus usuários.`
