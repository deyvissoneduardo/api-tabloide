...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-015. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar seu endereço no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar seu endereço.

---

## 8. Fluxo principal

1. O ator inicia cadastrar seu endereço.
...
- **RF-001:** O sistema deve cadastrar seu endereço.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar seu endereço"
...
- `cadastrar_endereco_iniciado`: início intencional do fluxo.
- `cadastrar_endereco_concluido`: após confirmação do resultado.
- `cadastrar_endereco_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-015 — O supermercado deve poder cadastrar seu endereço.`
