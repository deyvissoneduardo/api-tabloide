# US-186 — Produtos cadastrados devem poder ser reutilizados
...
**Quero** produtos cadastrados devem poder ser reutilizados  
...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-037. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar produtos cadastrados devem poder ser reutilizados no escopo autorizado.
...
2. O sistema aplica a qualidade “Produtos cadastrados devem poder ser reutilizados” antes de devolver o resultado.
...
- **RF-001:** O sistema deve produtos cadastrados devem poder ser reutilizados.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "produtos cadastrados devem poder ser reutilizados"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/produtos`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `produtos_cadastrados_devem_poder_ser_reutilizados_iniciado`: início intencional do fluxo.
- `produtos_cadastrados_devem_poder_ser_reutilizados_concluido`: após confirmação do resultado.
- `produtos_cadastrados_devem_poder_ser_reutilizados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-037 — Produtos cadastrados devem poder ser reutilizados.`
