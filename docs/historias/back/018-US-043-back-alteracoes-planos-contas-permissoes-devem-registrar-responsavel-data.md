# US-043 — Alterações de planos, contas e permissões devem registrar responsável e data
...
**Quero** alterações de planos, contas e permissões devem registrar responsável e data  
...
Esta história pertence a **Administração da plataforma**, domínio **Auditoria**. O requisito de origem é ADM-RNF-003. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar alterações de planos, contas e permissões devem registrar responsável e data no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita alterações de planos, contas e permissões devem registrar responsável e data.

---

## 8. Fluxo principal

1. O ator inicia alterações de planos, contas e permissões devem registrar responsável e data.
...
- **RF-001:** O sistema deve alterações de planos, contas e permissões devem registrar responsável e data.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "alterações de planos, contas e permissões devem registrar responsável e data"
...
- `alteracoes_planos_contas_permissoes_devem_registrar_responsavel_data_iniciado`: início intencional do fluxo.
- `alteracoes_planos_contas_permissoes_devem_registrar_responsavel_data_concluido`: após confirmação do resultado.
- `alteracoes_planos_contas_permissoes_devem_registrar_responsavel_data_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-003 — Alterações de planos, contas e permissões devem registrar responsável e data.`
