# US-081 — Associar o produto a uma categoria
...
**Quero** associar o produto a uma categoria  
...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-036. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar associar o produto a uma categoria no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita associar o produto a uma categoria.

---

## 8. Fluxo principal

1. O ator inicia associar o produto a uma categoria.
...
- **RF-001:** O sistema deve associar o produto a uma categoria.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "associar o produto a uma categoria"
...
- `associar_produto_categoria_iniciado`: início intencional do fluxo.
- `associar_produto_categoria_concluido`: após confirmação do resultado.
- `associar_produto_categoria_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-036 — O supermercado deve poder associar o produto a uma categoria.`
