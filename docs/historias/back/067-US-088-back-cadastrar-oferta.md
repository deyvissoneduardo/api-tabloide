...
- **Bloqueia:** Back/US-185, Back/US-187, Front/US-204, Front/US-205, Front/US-206, Front/US-207, Back/US-220
- **Risco:** Médio
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-045. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar uma oferta no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar uma oferta.

---

## 8. Fluxo principal

1. O ator inicia cadastrar uma oferta.
...
- **RF-001:** O sistema deve cadastrar uma oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar uma oferta"
...
- `cadastrar_oferta_iniciado`: início intencional do fluxo.
- `cadastrar_oferta_concluido`: após confirmação do resultado.
- `cadastrar_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-045 — O supermercado deve poder cadastrar uma oferta.`
