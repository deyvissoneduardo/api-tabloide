# US-052 — O acesso administrativo deve respeitar as regras de privacidade aplicáveis
...
**Quero** o acesso administrativo deve respeitar as regras de privacidade aplicáveis  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RNF-014. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar o acesso administrativo deve respeitar as regras de privacidade aplicáveis no escopo autorizado.
...
2. O sistema aplica a qualidade “O acesso administrativo deve respeitar as regras de privacidade aplicáveis” antes de devolver o resultado.
...
- **RF-001:** O sistema deve o acesso administrativo deve respeitar as regras de privacidade aplicáveis.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "o acesso administrativo deve respeitar as regras de privacidade aplicáveis"
...
- `acesso_administrativo_deve_respeitar_regras_privacidade_aplicaveis_iniciado`: início intencional do fluxo.
- `acesso_administrativo_deve_respeitar_regras_privacidade_aplicaveis_concluido`: após confirmação do resultado.
- `acesso_administrativo_deve_respeitar_regras_privacidade_aplicaveis_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-014 — O acesso administrativo deve respeitar as regras de privacidade aplicáveis.`
