# US-065 — Cadastrar seus dados de contato
...
**Quero** cadastrar seus dados de contato  
...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-014. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar seus dados de contato no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita cadastrar seus dados de contato.

---

## 8. Fluxo principal

1. O ator inicia cadastrar seus dados de contato.
...
- **RF-001:** O sistema deve cadastrar seus dados de contato.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar seus dados de contato"
...
- `cadastrar_dados_contato_iniciado`: início intencional do fluxo.
- `cadastrar_dados_contato_concluido`: após confirmação do resultado.
- `cadastrar_dados_contato_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-014 — O supermercado deve poder cadastrar seus dados de contato.`
