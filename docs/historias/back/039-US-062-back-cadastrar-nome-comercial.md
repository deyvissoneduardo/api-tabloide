# US-062 — Cadastrar seu nome comercial
...
**Quero** cadastrar seu nome comercial  
...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-011. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar seu nome comercial no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar seu nome comercial.

---

## 8. Fluxo principal

1. O ator inicia cadastrar seu nome comercial.
...
- **RF-001:** O sistema deve cadastrar seu nome comercial.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar seu nome comercial"
...
- `cadastrar_nome_comercial_iniciado`: início intencional do fluxo.
- `cadastrar_nome_comercial_concluido`: após confirmação do resultado.
- `cadastrar_nome_comercial_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-011 — O supermercado deve poder cadastrar seu nome comercial.`
