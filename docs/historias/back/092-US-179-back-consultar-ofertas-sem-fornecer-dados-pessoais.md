# US-179 — Consultar ofertas sem fornecer dados pessoais
...
**Como** consumidor  
**Quero** consultar ofertas sem fornecer dados pessoais  
...
Esta história pertence a **Supermercado**, domínio **Privacidade e consentimento**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-026. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar consultar ofertas sem fornecer dados pessoais no escopo autorizado.
...
O gatilho ocorre quando consumidor solicita consultar ofertas sem fornecer dados pessoais.

---

## 8. Fluxo principal

1. O ator acessa a consulta de consultar ofertas sem fornecer dados pessoais.
...
- **RF-001:** O sistema deve consultar ofertas sem fornecer dados pessoais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "consultar ofertas sem fornecer dados pessoais"
...
Rota: `/api/privacidade` ou `/api/privacidade/{id}`, conforme coleção ou detalhe.
...
- `consultar_ofertas_sem_fornecer_dados_pessoais_iniciado`: início intencional do fluxo.
- `consultar_ofertas_sem_fornecer_dados_pessoais_concluido`: após confirmação do resultado.
- `consultar_ofertas_sem_fornecer_dados_pessoais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-026 — O consumidor deve poder consultar ofertas sem fornecer dados pessoais.`
