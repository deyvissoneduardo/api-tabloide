# US-171 — Restringir ofertas vigentes devem ser apresentadas como atuais
...
**Quero** restringir ofertas vigentes devem ser apresentadas como atuais  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-018. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar restringir ofertas vigentes devem ser apresentadas como atuais no escopo autorizado.
...
2. O sistema aplica a qualidade “Apenas ofertas vigentes devem ser apresentadas como atuais” antes de devolver o resultado.
...
- **RF-001:** O sistema deve restringir ofertas vigentes devem ser apresentadas como atuais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "restringir ofertas vigentes devem ser apresentadas como atuais"
...
- `restringir_ofertas_vigentes_devem_ser_apresentadas_como_atuais_iniciado`: início intencional do fluxo.
- `restringir_ofertas_vigentes_devem_ser_apresentadas_como_atuais_concluido`: após confirmação do resultado.
- `restringir_ofertas_vigentes_devem_ser_apresentadas_como_atuais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-018 — Apenas ofertas vigentes devem ser apresentadas como atuais.`
