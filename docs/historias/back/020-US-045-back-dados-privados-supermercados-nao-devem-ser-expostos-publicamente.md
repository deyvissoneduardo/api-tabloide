# US-045 — Dados privados de supermercados não devem ser expostos publicamente
...
**Quero** dados privados de supermercados não devem ser expostos publicamente  
...
Esta história pertence a **Administração da plataforma**, domínio **Identidade e acesso**. O requisito de origem é ADM-RNF-006. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar dados privados de supermercados não devem ser expostos publicamente no escopo autorizado.
...
2. O sistema aplica a qualidade “Dados privados de supermercados não devem ser expostos publicamente” antes de devolver o resultado.
...
- **RF-001:** O sistema deve dados privados de supermercados não devem ser expostos publicamente.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "dados privados de supermercados não devem ser expostos publicamente"
...
- `dados_privados_supermercados_nao_devem_ser_expostos_publicamente_iniciado`: início intencional do fluxo.
- `dados_privados_supermercados_nao_devem_ser_expostos_publicamente_concluido`: após confirmação do resultado.
- `dados_privados_supermercados_nao_devem_ser_expostos_publicamente_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RNF-006 — Dados privados de supermercados não devem ser expostos publicamente.`
