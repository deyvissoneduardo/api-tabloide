...
Esta história pertence a **Supermercado**, domínio **Categorias**, seção “B4. Categorias”. O requisito de origem é SUP-RF-028. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar editar categorias no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita editar categorias.

---

## 8. Fluxo principal

1. O ator inicia editar categorias.
...
- **RF-001:** O sistema deve editar categorias.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "editar categorias"
...
- `editar_categorias_iniciado`: início intencional do fluxo.
- `editar_categorias_concluido`: após confirmação do resultado.
- `editar_categorias_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-028 — O supermercado deve poder editar categorias.`
