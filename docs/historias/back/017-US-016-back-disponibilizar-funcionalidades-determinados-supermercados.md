# US-016 — Disponibilizar funcionalidades para determinados supermercados
...
**Quero** que o MVP não disponibilize disponibilizar funcionalidades para determinados supermercados  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**. O requisito de origem é ADM-RF-038. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- **RF-001:** O sistema deve impedir a disponibilização de disponibilizar funcionalidades para determinados supermercados.
...
Cenário: Capacidade retirada permanece indisponível
  ...
  Quando solicitar "disponibilizar funcionalidades para determinados supermercados"
...
- `disponibilizar_funcionalidades_determinados_supermercados_iniciado`: início intencional do fluxo.
- `disponibilizar_funcionalidades_determinados_supermercados_concluido`: após confirmação do resultado.
- `disponibilizar_funcionalidades_determinados_supermercados_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-038 — O administrador deve poder disponibilizar funcionalidades para determinados supermercados.`
