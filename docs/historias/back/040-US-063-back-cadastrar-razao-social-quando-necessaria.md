# US-063 — Cadastrar sua razão social quando necessária
...
**Quero** cadastrar sua razão social quando necessária  
...
Esta história pertence a **Supermercado**, domínio **Supermercados e estados**, seção “B2. Cadastro do supermercado”. O requisito de origem é SUP-RF-012. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar sua razão social quando necessária no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar sua razão social quando necessária.

---

## 8. Fluxo principal

1. O ator inicia cadastrar sua razão social quando necessária.
...
- **RF-001:** O sistema deve cadastrar sua razão social quando necessária.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar sua razão social quando necessária"
...
- `cadastrar_razao_social_quando_necessaria_iniciado`: início intencional do fluxo.
- `cadastrar_razao_social_quando_necessaria_concluido`: após confirmação do resultado.
- `cadastrar_razao_social_quando_necessaria_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-012 — O supermercado deve poder cadastrar sua razão social quando necessária.`
