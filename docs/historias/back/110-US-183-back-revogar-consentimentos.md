...
**Como** consumidor  
**Quero** que o MVP não disponibilize revogar consentimentos  
...
Esta história pertence a **Supermercado**, domínio **Privacidade e consentimento**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-030. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Acesso público sem login nem cadastro.
- Nenhum dado administrativo ou pessoal é exposto.
...
- **RF-001:** O sistema deve impedir a disponibilização de revogar consentimentos.
...
Cenário: Capacidade retirada permanece indisponível
  ...
  Quando solicitar "revogar consentimentos"
...
- `revogar_consentimentos_iniciado`: início intencional do fluxo.
- `revogar_consentimentos_concluido`: após confirmação do resultado.
- `revogar_consentimentos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-030 — O consumidor deve poder revogar consentimentos.`
