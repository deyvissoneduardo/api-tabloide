# US-210 — Excluir logicamente um plano
...
**Quero** excluir logicamente um plano  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**, seção “Planos”. O requisito de origem é DEC-RF-003. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar excluir logicamente um plano no escopo autorizado.
...
2. O sistema aplica a qualidade “O Super Admin deve poder excluir logicamente um plano” antes de devolver o resultado.
...
- **RF-001:** O sistema deve excluir logicamente um plano.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "excluir logicamente um plano"
...
- `excluir_logicamente_plano_iniciado`: início intencional do fluxo.
- `excluir_logicamente_plano_concluido`: após confirmação do resultado.
- `excluir_logicamente_plano_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-003 — O Super Admin deve poder excluir logicamente um plano.`
