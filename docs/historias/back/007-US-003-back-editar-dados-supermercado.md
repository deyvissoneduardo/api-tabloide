# US-003 — Editar os dados de um supermercado
...
**Quero** editar os dados de um supermercado  
...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-008. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar editar os dados de um supermercado no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita editar os dados de um supermercado.

---

## 8. Fluxo principal

1. O ator inicia editar os dados de um supermercado.
...
- **RF-001:** O sistema deve editar os dados de um supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "editar os dados de um supermercado"
...
- `editar_dados_supermercado_iniciado`: início intencional do fluxo.
- `editar_dados_supermercado_concluido`: após confirmação do resultado.
- `editar_dados_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-008 — O administrador deve poder editar os dados de um supermercado.`
