# US-168 — A página pública deve estar disponível durante o funcionamento do supermercado
...
**Quero** a página pública deve estar disponível durante o funcionamento do supermercado  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-015. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a página pública deve estar disponível durante o funcionamento do supermercado no escopo autorizado.
...
2. O sistema aplica a qualidade “A página pública deve estar disponível durante o funcionamento do supermercado” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a página pública deve estar disponível durante o funcionamento do supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a página pública deve estar disponível durante o funcionamento do supermercado"
...
- `pagina_publica_deve_estar_disponivel_durante_funcionamento_supermercad_iniciado`: início intencional do fluxo.
- `pagina_publica_deve_estar_disponivel_durante_funcionamento_supermercad_concluido`: após confirmação do resultado.
- `pagina_publica_deve_estar_disponivel_durante_funcionamento_supermercad_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-015 — A página pública deve estar disponível durante o funcionamento do supermercado.`
