# US-101 — Organizar ofertas por categoria
...
**Quero** organizar ofertas por categoria  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B8. Página pública do supermercado”. O requisito de origem é SUP-RF-078. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar organizar ofertas por categoria no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita organizar ofertas por categoria.

---

## 8. Fluxo principal

1. O ator acessa a consulta de organizar ofertas por categoria.
...
- **RF-001:** O sistema deve organizar ofertas por categoria.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "organizar ofertas por categoria"
...
Rota: `/api/publico/ofertas` ou `/api/publico/ofertas/{id}`, conforme coleção ou detalhe.
...
- `organizar_ofertas_categoria_iniciado`: início intencional do fluxo.
- `organizar_ofertas_categoria_concluido`: após confirmação do resultado.
- `organizar_ofertas_categoria_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-078 — A página deve organizar ofertas por categoria.`
