# US-175 — Um supermercado não deve acessar os dados privados de outro
...
**Quero** um supermercado não deve acessar os dados privados de outro  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-022. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar um supermercado não deve acessar os dados privados de outro no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita um supermercado não deve acessar os dados privados de outro.

---

## 8. Fluxo principal

1. O ator acessa a consulta de um supermercado não deve acessar os dados privados de outro.
...
- **RF-001:** O sistema deve um supermercado não deve acessar os dados privados de outro.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "um supermercado não deve acessar os dados privados de outro"
...
- `supermercado_nao_deve_acessar_dados_privados_outro_iniciado`: início intencional do fluxo.
- `supermercado_nao_deve_acessar_dados_privados_outro_concluido`: após confirmação do resultado.
- `supermercado_nao_deve_acessar_dados_privados_outro_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-022 — Um supermercado não deve acessar os dados privados de outro.`
