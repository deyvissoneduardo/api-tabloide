# US-220 — Criar e administrar campanhas
...
- **Dependências:** Back/US-056, Back/US-088
- **Bloqueia:** Back/US-185, Back/US-187, Front/US-204, Front/US-205, Front/US-206, Front/US-207
- **Risco:** Alto
...
**Quero** criar e administrar campanhas  
...
Esta história pertence a **Supermercado**, domínio **Campanhas**, seção “Campanhas”. O requisito de origem é DEC-RF-013. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar criar e administrar campanhas no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita criar e administrar campanhas.

---

## 8. Fluxo principal

1. O ator inicia criar e administrar campanhas.
...
- **RF-001:** O sistema deve criar e administrar campanhas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "criar e administrar campanhas"
...
- `criar_administrar_campanhas_iniciado`: início intencional do fluxo.
- `criar_administrar_campanhas_concluido`: após confirmação do resultado.
- `criar_administrar_campanhas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-013 — O supermercado deve criar e administrar campanhas.`
- Decisões aplicáveis: seção “Campanhas” de `docs/historias/decisoes-mvp.md`.
- Histórias relacionadas: US-056, US-088.
