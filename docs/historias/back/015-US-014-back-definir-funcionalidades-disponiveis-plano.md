# US-014 — Definir funcionalidades disponíveis por plano
...
**Quero** que o MVP não disponibilize definir funcionalidades disponíveis por plano  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**. O requisito de origem é ADM-RF-036. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- **RF-001:** O sistema deve impedir a disponibilização de definir funcionalidades disponíveis por plano.
...
Cenário: Capacidade retirada permanece indisponível
  ...
  Quando solicitar "definir funcionalidades disponíveis por plano"
...
- `definir_funcionalidades_disponiveis_plano_iniciado`: início intencional do fluxo.
- `definir_funcionalidades_disponiveis_plano_concluido`: após confirmação do resultado.
- `definir_funcionalidades_disponiveis_plano_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-036 — O administrador deve poder definir funcionalidades disponíveis por plano.`
