...
Esta história pertence a **Supermercado**, domínio **Conteúdos promocionais**, seção “B20. Conteúdos promocionais”. O requisito de origem é SUP-RF-167. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar cadastrar banners no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita cadastrar banners.

---

## 8. Fluxo principal

1. O ator inicia cadastrar banners.
...
- **RF-001:** O sistema deve cadastrar banners.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "cadastrar banners"
...
- `cadastrar_banners_iniciado`: início intencional do fluxo.
- `cadastrar_banners_concluido`: após confirmação do resultado.
- `cadastrar_banners_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-167 — O supermercado deve poder cadastrar banners.`
