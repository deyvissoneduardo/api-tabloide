# US-099 — Copiar uma oferta existente
...
**Quero** copiar uma oferta existente  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-059. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar copiar uma oferta existente no escopo autorizado.
...
2. O sistema aplica a qualidade “O supermercado deve poder copiar uma oferta existente” antes de devolver o resultado.
...
- **RF-001:** O sistema deve copiar uma oferta existente.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "copiar uma oferta existente"
...
- `copiar_oferta_existente_iniciado`: início intencional do fluxo.
- `copiar_oferta_existente_concluido`: após confirmação do resultado.
- `copiar_oferta_existente_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-059 — O supermercado deve poder copiar uma oferta existente.`
