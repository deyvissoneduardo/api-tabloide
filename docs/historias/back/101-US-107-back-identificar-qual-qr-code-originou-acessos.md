...
**Quero** identificar qual qr code originou os acessos  
...
Esta história pertence a **Supermercado**, domínio **QR Codes**, seção “B9. QR Code”. O requisito de origem é SUP-RF-097. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar identificar qual qr code originou os acessos no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita identificar qual qr code originou os acessos.

---

## 8. Fluxo principal

1. O ator acessa a consulta de identificar qual qr code originou os acessos.
...
- **RF-001:** O sistema deve identificar qual qr code originou os acessos.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "identificar qual qr code originou os acessos"
...
Rota: `/api/qrcodes` ou `/api/qrcodes/{id}`, conforme coleção ou detalhe.
...
- `identificar_qual_qr_code_originou_acessos_iniciado`: início intencional do fluxo.
- `identificar_qual_qr_code_originou_acessos_concluido`: após confirmação do resultado.
- `identificar_qual_qr_code_originou_acessos_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-097 — O supermercado deve poder identificar qual QR Code originou os acessos.`
