# US-209 — Editar planos para associações futuras
...
**Quero** editar planos para associações futuras  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**, seção “Planos”. O requisito de origem é DEC-RF-002. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar editar planos para associações futuras no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita editar planos para associações futuras.

---

## 8. Fluxo principal

1. O ator inicia editar planos para associações futuras.
...
- **RF-001:** O sistema deve editar planos para associações futuras.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "editar planos para associações futuras"
...
- `editar_planos_associacoes_futuras_iniciado`: início intencional do fluxo.
- `editar_planos_associacoes_futuras_concluido`: após confirmação do resultado.
- `editar_planos_associacoes_futuras_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-002 — O Super Admin deve poder editar planos para associações futuras.`
