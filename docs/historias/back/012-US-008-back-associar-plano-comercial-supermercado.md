# US-008 — Associar um plano comercial a um supermercado
...
**Quero** associar um plano comercial a um supermercado  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**. O requisito de origem é ADM-RF-016. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar associar um plano comercial a um supermercado no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita associar um plano comercial a um supermercado.

---

## 8. Fluxo principal

1. O ator inicia associar um plano comercial a um supermercado.
...
- **RF-001:** O sistema deve associar um plano comercial a um supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "associar um plano comercial a um supermercado"
...
- `associar_plano_comercial_supermercado_iniciado`: início intencional do fluxo.
- `associar_plano_comercial_supermercado_concluido`: após confirmação do resultado.
- `associar_plano_comercial_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-016 — O administrador deve poder associar um plano comercial a um supermercado.`
