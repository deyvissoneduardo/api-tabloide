# US-176 — Usuários devem respeitar suas permissões
...
**Quero** usuários devem respeitar suas permissões  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-023. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar usuários devem respeitar suas permissões no escopo autorizado.
...
2. O sistema aplica a qualidade “Usuários devem respeitar suas permissões” antes de devolver o resultado.
...
- **RF-001:** O sistema deve usuários devem respeitar suas permissões.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "usuários devem respeitar suas permissões"
...
- `usuarios_devem_respeitar_permissoes_iniciado`: início intencional do fluxo.
- `usuarios_devem_respeitar_permissoes_concluido`: após confirmação do resultado.
- `usuarios_devem_respeitar_permissoes_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-023 — Usuários devem respeitar suas permissões.`
