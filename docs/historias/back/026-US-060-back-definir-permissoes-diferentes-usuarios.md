# US-060 — Definir permissões diferentes para seus usuários
...
**Quero** definir permissões diferentes para seus usuários  
...
Esta história pertence a **Supermercado**, domínio **Identidade e acesso**, seção “B1. Conta e acesso do supermercado”. O requisito de origem é SUP-RF-008. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar definir permissões diferentes para seus usuários no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita definir permissões diferentes para seus usuários.

---

## 8. Fluxo principal

1. O ator inicia definir permissões diferentes para seus usuários.
...
- **RF-001:** O sistema deve definir permissões diferentes para seus usuários.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "definir permissões diferentes para seus usuários"
...
- `definir_permissoes_diferentes_usuarios_iniciado`: início intencional do fluxo.
- `definir_permissoes_diferentes_usuarios_concluido`: após confirmação do resultado.
- `definir_permissoes_diferentes_usuarios_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-008 — O supermercado deve poder definir permissões diferentes para seus usuários.`
