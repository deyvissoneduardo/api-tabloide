# US-012 — Identificar qual usuário realizou determinada alteração administrativa
...
**Quero** identificar qual usuário realizou determinada alteração administrativa  
...
Esta história pertence a **Administração da plataforma**, domínio **Auditoria**. O requisito de origem é ADM-RF-033. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar identificar qual usuário realizou determinada alteração administrativa no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita identificar qual usuário realizou determinada alteração administrativa.

---

## 8. Fluxo principal

1. O ator acessa a consulta de identificar qual usuário realizou determinada alteração administrativa.
...
- **RF-001:** O sistema deve identificar qual usuário realizou determinada alteração administrativa.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "identificar qual usuário realizou determinada alteração administrativa"
...
Rota: `/api/auditoria` ou `/api/auditoria/{id}`, conforme coleção ou detalhe.
...
- `identificar_qual_usuario_realizou_determinada_alteracao_administrativa_iniciado`: início intencional do fluxo.
- `identificar_qual_usuario_realizou_determinada_alteracao_administrativa_concluido`: após confirmação do resultado.
- `identificar_qual_usuario_realizou_determinada_alteracao_administrativa_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-033 — O administrador deve poder identificar qual usuário realizou determinada alteração administrativa.`
