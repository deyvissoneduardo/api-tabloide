# US-181 — A finalidade da coleta deve ser informada
...
**Quero** a finalidade da coleta deve ser informada  
...
Esta história pertence a **Supermercado**, domínio **Privacidade e consentimento**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-028. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar a finalidade da coleta deve ser informada no escopo autorizado.
...
2. O sistema aplica a qualidade “A finalidade da coleta deve ser informada” antes de devolver o resultado.
...
- **RF-001:** O sistema deve a finalidade da coleta deve ser informada.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "a finalidade da coleta deve ser informada"
...
- `finalidade_coleta_deve_ser_informada_iniciado`: início intencional do fluxo.
- `finalidade_coleta_deve_ser_informada_concluido`: após confirmação do resultado.
- `finalidade_coleta_deve_ser_informada_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-028 — A finalidade da coleta deve ser informada.`
