# US-087 — Reutilizar produtos em futuras campanhas
...
**Quero** reutilizar produtos em futuras campanhas  
...
Esta história pertence a **Supermercado**, domínio **Produtos**, seção “B5. Produtos”. O requisito de origem é SUP-RF-042. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar reutilizar produtos em futuras campanhas no escopo autorizado.
...
2. O sistema aplica a qualidade “O supermercado deve poder reutilizar produtos em futuras campanhas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve reutilizar produtos em futuras campanhas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "reutilizar produtos em futuras campanhas"
...
- `reutilizar_produtos_em_futuras_campanhas_iniciado`: início intencional do fluxo.
- `reutilizar_produtos_em_futuras_campanhas_concluido`: após confirmação do resultado.
- `reutilizar_produtos_em_futuras_campanhas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-042 — O supermercado deve poder reutilizar produtos em futuras campanhas.`
