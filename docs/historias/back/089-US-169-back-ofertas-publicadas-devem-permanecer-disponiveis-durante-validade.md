# US-169 — Ofertas publicadas devem permanecer disponíveis durante sua validade
...
**Quero** ofertas publicadas devem permanecer disponíveis durante sua validade  
...
Esta história pertence a **Supermercado**, domínio **Página pública**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-016. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ofertas publicadas devem permanecer disponíveis durante sua validade no escopo autorizado.
...
2. O sistema aplica a qualidade “Ofertas publicadas devem permanecer disponíveis durante sua validade” antes de devolver o resultado.
...
- **RF-001:** O sistema deve ofertas publicadas devem permanecer disponíveis durante sua validade.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ofertas publicadas devem permanecer disponíveis durante sua validade"
...
- `ofertas_publicadas_devem_permanecer_disponiveis_durante_validade_iniciado`: início intencional do fluxo.
- `ofertas_publicadas_devem_permanecer_disponiveis_durante_validade_concluido`: após confirmação do resultado.
- `ofertas_publicadas_devem_permanecer_disponiveis_durante_validade_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-016 — Ofertas publicadas devem permanecer disponíveis durante sua validade.`
