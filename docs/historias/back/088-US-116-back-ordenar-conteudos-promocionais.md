# US-116 — Ordenar conteúdos promocionais
...
**Quero** ordenar conteúdos promocionais  
...
Esta história pertence a **Supermercado**, domínio **Conteúdos promocionais**, seção “B20. Conteúdos promocionais”. O requisito de origem é SUP-RF-169. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar ordenar conteúdos promocionais no escopo autorizado.
...
O gatilho ocorre quando responsável pelo produto solicita ordenar conteúdos promocionais.

---

## 8. Fluxo principal

1. O ator inicia ordenar conteúdos promocionais.
...
- **RF-001:** O sistema deve ordenar conteúdos promocionais.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "ordenar conteúdos promocionais"
...
- `ordenar_conteudos_promocionais_iniciado`: início intencional do fluxo.
- `ordenar_conteudos_promocionais_concluido`: após confirmação do resultado.
- `ordenar_conteudos_promocionais_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-169 — O supermercado deve poder ordenar conteúdos promocionais.`
