# US-106 — Contabilizar acessos originados por QR Code
...
- **Bloqueia:** Back/US-010, Back/US-011, Front/US-028, Front/US-029, Front/US-030, Front/US-031, Front/US-032, Front/US-033, Front/US-034, Front/US-035, Front/US-036, Front/US-037, Front/US-040, Back/US-046, Front/US-055, Front/US-142, Front/US-143, Front/US-144, Front/US-145, Front/US-146, Front/US-147, Front/US-148, Front/US-149, Front/US-150, Front/US-151, Front/US-152, Front/US-153, Front/US-154, Front/US-155, Front/US-156, Front/US-157, Front/US-158, Front/US-159, Front/US-160, Back/US-173, Back/US-222, Front/US-223
- **Risco:** Alto
...
**Quero** contabilizar acessos originados por qr code  
...
Esta história pertence a **Supermercado**, domínio **QR Codes**, seção “B9. QR Code”. O requisito de origem é SUP-RF-096. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar contabilizar acessos originados por qr code no escopo autorizado.
...
2. O sistema aplica a qualidade “O sistema deve contabilizar acessos originados por QR Code” antes de devolver o resultado.
...
- **RF-001:** O sistema deve contabilizar acessos originados por qr code.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "contabilizar acessos originados por qr code"
...
- `contabilizar_acessos_originados_qr_code_iniciado`: início intencional do fluxo.
- `contabilizar_acessos_originados_qr_code_concluido`: após confirmação do resultado.
- `contabilizar_acessos_originados_qr_code_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-096 — O sistema deve contabilizar acessos originados por QR Code.`
