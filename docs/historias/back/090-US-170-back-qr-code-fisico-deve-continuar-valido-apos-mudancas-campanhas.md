# US-170 — O QR Code físico deve continuar válido após mudanças de campanhas
...
**Quero** o qr code físico deve continuar válido após mudanças de campanhas  
...
Esta história pertence a **Supermercado**, domínio **QR Codes**, seção “B21. Multi-loja / rede”. O requisito de origem é SUP-RNF-017. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar o qr code físico deve continuar válido após mudanças de campanhas no escopo autorizado.
...
2. O sistema aplica a qualidade “O QR Code físico deve continuar válido após mudanças de campanhas” antes de devolver o resultado.
...
- **RF-001:** O sistema deve o qr code físico deve continuar válido após mudanças de campanhas.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "o qr code físico deve continuar válido após mudanças de campanhas"
...
- `qr_code_fisico_deve_continuar_valido_apos_mudancas_campanhas_iniciado`: início intencional do fluxo.
- `qr_code_fisico_deve_continuar_valido_apos_mudancas_campanhas_concluido`: após confirmação do resultado.
- `qr_code_fisico_deve_continuar_valido_apos_mudancas_campanhas_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RNF-017 — O QR Code físico deve continuar válido após mudanças de campanhas.`
