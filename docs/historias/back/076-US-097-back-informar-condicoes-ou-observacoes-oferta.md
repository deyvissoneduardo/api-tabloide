# US-097 — Informar condições ou observações da oferta
...
**Quero** informar condições ou observações da oferta  
...
Esta história pertence a **Supermercado**, domínio **Promoções e ofertas**, seção “B6. Ofertas”. O requisito de origem é SUP-RF-057. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar informar condições ou observações da oferta no escopo autorizado.
...
O gatilho ocorre quando usuário autorizado do supermercado solicita informar condições ou observações da oferta.

---

## 8. Fluxo principal

1. O ator inicia informar condições ou observações da oferta.
...
- **RF-001:** O sistema deve informar condições ou observações da oferta.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "informar condições ou observações da oferta"
...
- `informar_condicoes_ou_observacoes_oferta_iniciado`: início intencional do fluxo.
- `informar_condicoes_ou_observacoes_oferta_concluido`: após confirmação do resultado.
- `informar_condicoes_ou_observacoes_oferta_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `SUP-RF-057 — O supermercado deve poder informar condições ou observações da oferta.`
