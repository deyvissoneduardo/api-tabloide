# US-211 — Renovar a assinatura de um supermercado
...
**Quero** renovar a assinatura de um supermercado  
...
Esta história pertence a **Administração da plataforma**, domínio **Planos e assinaturas**, seção “Assinaturas”. O requisito de origem é DEC-RF-004. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar renovar a assinatura de um supermercado no escopo autorizado.
...
2. O sistema aplica a qualidade “O Super Admin deve poder renovar a assinatura de um supermercado” antes de devolver o resultado.
...
- **RF-001:** O sistema deve renovar a assinatura de um supermercado.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "renovar a assinatura de um supermercado"
...
A capacidade é transversal e deve ser validada nos endpoints afetados de `/api/planos`. Não cria endpoint exclusivo quando puder ser aplicada como requisito de qualidade.
...
- `renovar_assinatura_supermercado_iniciado`: início intencional do fluxo.
- `renovar_assinatura_supermercado_concluido`: após confirmação do resultado.
- `renovar_assinatura_supermercado_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `DEC-RF-004 — O Super Admin deve poder renovar a assinatura de um supermercado.`
