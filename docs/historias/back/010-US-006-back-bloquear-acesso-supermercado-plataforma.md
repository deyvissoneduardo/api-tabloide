# US-006 — Bloquear o acesso de um supermercado à plataforma
...
**Quero** bloquear o acesso de um supermercado à plataforma  
...
Esta história pertence a **Administração da plataforma**, domínio **Supermercados e estados**. O requisito de origem é ADM-RF-013. As decisões de 24/08/2026 têm precedência sobre interpretações anteriores e foram incorporadas abaixo.
...
- Executar bloquear o acesso de um supermercado à plataforma no escopo autorizado.
...
O gatilho ocorre quando Super Admin do SGTM solicita bloquear o acesso de um supermercado à plataforma.

---

## 8. Fluxo principal

1. O ator seleciona o recurso e solicita bloquear o acesso de um supermercado à plataforma.
...
- **RF-001:** O sistema deve bloquear o acesso de um supermercado à plataforma.
...
Cenário: Executar com dados e estado válidos
  ...
  Quando solicitar "bloquear o acesso de um supermercado à plataforma"
...
Rota: `/api/supermercados/{id}/acoes/{acao}`
...
- `bloquear_acesso_supermercado_plataforma_iniciado`: início intencional do fluxo.
- `bloquear_acesso_supermercado_plataforma_concluido`: após confirmação do resultado.
- `bloquear_acesso_supermercado_plataforma_erro`: término sem conclusão, com categoria não sensível.
...
- Item de origem: `ADM-RF-013 — O administrador deve poder bloquear o acesso de um supermercado à plataforma.`
