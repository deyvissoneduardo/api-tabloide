...
@Component
public class EditarConteudoGeral {

    private final ConteudoGeralRepository conteudoGeralRepository;
    private final AuditoriaRepository auditoriaRepository;

    public EditarConteudoGeral(ConteudoGeralRepository conteudoGeralRepository, AuditoriaRepository auditoriaRepository) {
        this.conteudoGeralRepository = conteudoGeralRepository;
        this.auditoriaRepository = auditoriaRepository;
    }

    @Transactional
    public ConteudoGeral executar(Long id, Long versaoConhecida, String titulo, String corpo, Long atorId, Perfil perfilAtor) {
