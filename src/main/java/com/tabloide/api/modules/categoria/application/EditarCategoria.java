...
public class EditarCategoria {
    ...
    public EditarCategoria(CategoriaRepository categoriaRepository, AuditoriaRepository auditoriaRepository) {
    ...
    public Categoria executar(
            Long supermercadoId, Long id, Long versaoConhecida, DadosCategoria dados,
