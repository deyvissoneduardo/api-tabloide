...
public class CancelarOferta {
    ...
    public CancelarOferta(OfertaRepository ofertaRepository, AuditoriaRepository auditoriaRepository) {
    ...
    public Oferta executar(Long supermercadoId, Long ofertaId, Long atorId, Perfil perfilAtor, Long supermercadoIdAtor) {
        ...
        auditoriaRepository.registrar(new RegistroAuditoria(
                null, atorId, perfilAtor, supermercadoId, "OFERTA_CANCELADA", "Oferta", salva.id(),
