...
@Component
public class DesativarLoja {

    private final LojaRepository lojaRepository;
    private final AuditoriaRepository auditoriaRepository;

    public DesativarLoja(LojaRepository lojaRepository, AuditoriaRepository auditoriaRepository) {
