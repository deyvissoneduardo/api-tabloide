...
public class DesativarProduto {
    ...
    public DesativarProduto(ProdutoRepository produtoRepository, AuditoriaRepository auditoriaRepository,
    ...
    public Produto executar(Long supermercadoId, Long produtoId, Long atorId, Perfil perfilAtor, Long supermercadoIdAtor) {
        ...
        auditoriaRepository.registrar(new RegistroAuditoria(
                null, atorId, perfilAtor, supermercadoId, "PRODUTO_DESATIVADO", "Produto", salvo.id(),
