...
@Component
public class AtivarQrCode {

    private final QrCodeRepository qrCodeRepository;
    private final AuditoriaRepository auditoriaRepository;

    public AtivarQrCode(QrCodeRepository qrCodeRepository, AuditoriaRepository auditoriaRepository) {
    ...
    public QrCode executar(Long supermercadoId, Long id, Long atorId, Perfil perfilAtor, Long supermercadoIdAtor) {
        ...
        auditoriaRepository.registrar(new RegistroAuditoria(
                null, atorId, perfilAtor, supermercadoId, "QRCODE_ATIVADO", "QrCode", salvo.id(),
